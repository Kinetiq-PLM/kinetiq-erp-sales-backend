"""
Django settings for sales_backend project.
...
SECRET_KEY = "django-insecure-$s!xjez846m_#wr#1lmcz)4busv#r1d97u)zy9x3^0m*=pz3zz"
...
ROOT_URLCONF = "sales_backend.urls"
...
WSGI_APPLICATION = "sales_backend.wsgi.application"
