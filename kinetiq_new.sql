...
BEGIN
	...
	VALUES (NEW.order_id, NEW.order_id, NOW(), 
		NEW.order_total_amount, 
		'Pending', 'Pending', NOW() + INTERVAL '7 days'); -- di ko sure kung ilan ung interval
	RETURN NEW;
END;
$$;
...
BEGIN
	...
	UPDATE sales.statement SET ext_project_request_id = ext_id WHERE statement_id = NEW.statement_id;
    END IF;
...
--
-- Name: update_invoice_from_shipping_details(); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.update_invoice_from_shipping_details() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
DECLARE 
    total_shipping DECIMAL(10,2);
BEGIN
	IF NEW.shipment_id IS NOT NULL AND NEW.delivery_status <> 'Shipped'::delivery_status_enum THEN
		SELECT sc.total_shipping_cost INTO total_shipping FROM sales.shipping_details sd INNER JOIN sales.orders o ON sd.order_id = o.order_id INNER JOIN distribution.shipment_details sm ON sd.shipment_id = sm.shipment_id INNER JOIN distribution.shipping_cost sc ON sm.shipping_cost_id = sc.shipping_cost_id WHERE sd.order_id = NEW.order_id;
		UPDATE sales.sales_invoices SET total_amount = total_amount + total_shipping WHERE order_id = NEW.order_id;    -- shipping cost = invoice's total_amount - order's total_amount
		UPDATE sales.shipping_details SET delivery_status = 'Shipped'::delivery_status_enum  WHERE shipping_id = NEW.shipping_id;
		UPDATE sales.orders SET order_status = 'Shipped'::order_status_enum WHERE order_id = NEW.order_id;
	END IF;
	RETURN NEW;
END;
$$;
...
ALTER FUNCTION public.update_invoice_from_shipping_details() OWNER TO postgres;

--
-- Name: update_order_and_invoice_status_on_payment(); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.update_order_and_invoice_status_on_payment() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN 
...
ALTER FUNCTION public.update_order_and_invoice_status_on_payment() OWNER TO postgres;
...
ACC-GLA-2025-bd61fe	Lung Center of America	SALES-CUST-2025-3802d4	SALES-CUST-2025-3802d4	Active	2025-03-31 08:53:18.244865
ACC-GLA-2025-fe26b7	Sample	SALES-CUST-2025-fc3a85	SALES-CUST-2025-fc3a85	Active	2025-04-01 03:39:14.939926
\.
...
ADMIN-PARTNER-2025-84fcb0	\N	\N	SALES-CUST-2025-3802d4	Lung Center of America	Customer	09123456789
ADMIN-PARTNER-2025-ab8699	\N	\N	SALES-CUST-2025-fc3a85	Sample	Customer	09123456789
\.
...
DIS-BR-2025-64b6a8	DIS-CAR-2025-3e118a	2025-04-02	Pending	TRK1234	2025-04-04 02:14:51	\N	\N	DIS-PC-2025-694f39	DIS-SC-2025-be47e9
DIS-BR-2025-4a6596	DIS-CAR-2025-3252ad	2025-04-01	Shipped	TRK0023	2025-04-02 04:36:59	\N	\N	\N	DIS-SC-2025-d6bf1a
\.
...
DIS-SC-2025-be47e9	DIS-PC-2025-a46fdf	100.00	200.00	5.00	2.00	900.00
DIS-SC-2025-d6bf1a	DIS-PC-2025-d7ec28	100.00	20.00	5.00	10.00	700.00
\.
...
MRP-NPC-2025-0a31b9	SALES-ORD-2025-3d77ab	\N	0	0.00	0.00
MRP-NPC-2025-381b6c	SALES-ORD-2025-c6b85a	\N	0	0.00	0.00
MRP-NPC-2025-25a1f8	SALES-ORD-2025-63cc4b	\N	0	0.00	0.00
MRP-NPC-2025-1fd51b	SALES-ORD-2025-4e474f	\N	0	0.00	0.00
MRP-NPC-2025-8f0167	SALES-ORD-2025-3bfd38	\N	0	0.00	0.00
MRP-NPC-2025-9df95f	SALES-ORD-2025-d690bb	\N	0	0.00	0.00
MRP-NPC-2025-a796d5	SALES-ORD-2025-d6280a	\N	0	0.00	0.00
MRP-NPC-2025-e3b323	SALES-ORD-2025-befd65	\N	0	0.00	0.00
MRP-NPC-2025-87f47a	SALES-ORD-2025-f7f579	\N	0	0.00	0.00
MRP-NPC-2025-936c2a	SALES-ORD-2025-de16af	\N	0	0.00	0.00
MRP-NPC-2025-ad9004	SALES-ORD-2025-ca30a5	\N	0	0.00	0.00
MRP-NPC-2025-3de755	SALES-ORD-2025-38c24e	\N	0	0.00	0.00
MRP-NPC-2025-ad80c4	SALES-ORD-2025-d8c058	\N	0	0.00	0.00
MRP-NPC-2025-5dc46c	SALES-ORD-2025-393647	\N	0	0.00	0.00
\.
...
334	2025-04-01 12:35:46.001443+08	a	ShippingCost object (a)	1	[{"added": {}}]	31	1
...
335	2025-04-01 12:37:18.438028+08	a	ShipmentDetails object (a)	1	[{"added": {}}]	30	1
...
291	2025-03-30 12:48:53.742474+08	a	SalesInvoices object (a)	1	[{"added": {}}]	15	1
292	2025-03-30 17:04:52.999266+08	SALES-STI-2025-284852	StatementItem object (SALES-STI-2025-284852)	2	[{"changed": {"fields": ["Unit price", "Total price", "Discount", "Tax amount"]}}]	10	1
293	2025-03-30 17:05:48.119129+08	SALES-STM-2025-5e569c	Statement object (SALES-STM-2025-5e569c)	2	[{"changed": {"fields": ["Total amount", "Discount", "Total tax"]}}]	7	1
294	2025-03-30 22:31:21.633513+08	SALES-SHIP-2025-f8aebf	ShippingDetails object (SALES-SHIP-2025-f8aebf)	3		18	1
295	2025-03-31 11:13:38.535711+08	SALES-STM-2025-c86ce6	Statement object (SALES-STM-2025-c86ce6)	2	[{"changed": {"fields": ["Total amount", "Total tax"]}}]	7	1
296	2025-03-31 11:14:57.247718+08	SALES-STI-2025-f090bb	StatementItem object (SALES-STI-2025-f090bb)	2	[{"changed": {"fields": ["Unit price", "Total price", "Tax amount"]}}]	10	1
297	2025-03-31 11:17:39.309316+08	SALES-STI-2025-0361bc	StatementItem object (SALES-STI-2025-0361bc)	2	[{"changed": {"fields": ["Unit price", "Total price", "Tax amount"]}}]	10	1
298	2025-03-31 11:19:37.059384+08	SALES-STM-2025-f4b14f	Statement object (SALES-STM-2025-f4b14f)	2	[{"changed": {"fields": ["Total amount", "Total tax"]}}]	7	1
299	2025-03-31 11:20:22.290648+08	SALES-STI-2025-a09a62	StatementItem object (SALES-STI-2025-a09a62)	2	[{"changed": {"fields": ["Unit price", "Total price", "Tax amount"]}}]	10	1
300	2025-03-31 11:21:24.497492+08	SALES-STM-2025-656095	Statement object (SALES-STM-2025-656095)	2	[{"changed": {"fields": ["Total amount", "Discount", "Total tax"]}}]	7	1
301	2025-03-31 11:22:01.107696+08	SALES-STI-2025-6e1e9d	StatementItem object (SALES-STI-2025-6e1e9d)	2	[{"changed": {"fields": ["Unit price", "Total price", "Tax amount"]}}]	10	1
302	2025-03-31 11:22:48.207624+08	SALES-STM-2025-948f52	Statement object (SALES-STM-2025-948f52)	2	[{"changed": {"fields": ["Total amount", "Total tax"]}}]	7	1
303	2025-03-31 11:24:32.097728+08	SALES-STI-2025-87ad28	StatementItem object (SALES-STI-2025-87ad28)	2	[{"changed": {"fields": ["Unit price", "Total price", "Tax amount"]}}]	10	1
304	2025-03-31 11:25:37.067657+08	SALES-STM-2025-2f3fae	Statement object (SALES-STM-2025-2f3fae)	2	[{"changed": {"fields": ["Total amount", "Total tax"]}}]	7	1
305	2025-03-31 11:26:30.903117+08	SALES-STI-2025-262ddf	StatementItem object (SALES-STI-2025-262ddf)	2	[{"changed": {"fields": ["Unit price", "Total price", "Tax amount"]}}]	10	1
306	2025-03-31 11:27:18.597657+08	SALES-STM-2025-35c700	Statement object (SALES-STM-2025-35c700)	2	[{"changed": {"fields": ["Total amount", "Total tax"]}}]	7	1
307	2025-03-31 11:28:02.621787+08	SALES-STI-2025-391666	StatementItem object (SALES-STI-2025-391666)	2	[{"changed": {"fields": ["Unit price", "Total price", "Tax amount"]}}]	10	1
308	2025-03-31 11:29:01.028906+08	SALES-STM-2025-2879fa	Statement object (SALES-STM-2025-2879fa)	2	[{"changed": {"fields": ["Total amount", "Total tax"]}}]	7	1
309	2025-03-31 11:29:43.868024+08	SALES-STI-2025-0501db	StatementItem object (SALES-STI-2025-0501db)	2	[{"changed": {"fields": ["Unit price", "Total price", "Tax amount"]}}]	10	1
310	2025-03-31 11:30:17.378908+08	SALES-STM-2025-600a2f	Statement object (SALES-STM-2025-600a2f)	2	[{"changed": {"fields": ["Total amount", "Total tax"]}}]	7	1
311	2025-03-31 11:30:53.117651+08	SALES-STI-2025-fbdf4d	StatementItem object (SALES-STI-2025-fbdf4d)	2	[{"changed": {"fields": ["Unit price", "Total price", "Tax amount"]}}]	10	1
312	2025-03-31 11:31:26.735104+08	SALES-STM-2025-b90b4b	Statement object (SALES-STM-2025-b90b4b)	2	[{"changed": {"fields": ["Total amount", "Total tax"]}}]	7	1
313	2025-03-31 11:32:12.291117+08	SALES-STI-2025-900021	StatementItem object (SALES-STI-2025-900021)	2	[{"changed": {"fields": ["Unit price", "Total price", "Tax amount"]}}]	10	1
314	2025-03-31 11:33:07.660491+08	SALES-STM-2025-755417	Statement object (SALES-STM-2025-755417)	2	[{"changed": {"fields": ["Total amount", "Total tax"]}}]	7	1
315	2025-03-31 11:34:27.403043+08	SALES-STI-2025-c956cf	StatementItem object (SALES-STI-2025-c956cf)	2	[{"changed": {"fields": ["Unit price", "Total price", "Tax amount"]}}]	10	1
316	2025-03-31 11:35:02.757989+08	SALES-STI-2025-b58f6a	StatementItem object (SALES-STI-2025-b58f6a)	2	[{"changed": {"fields": ["Unit price", "Total price", "Tax amount"]}}]	10	1
317	2025-03-31 11:36:01.007956+08	SALES-STM-2025-5e569c	Statement object (SALES-STM-2025-5e569c)	2	[{"changed": {"fields": ["Total tax"]}}]	7	1
318	2025-03-31 11:36:40.197933+08	SALES-STI-2025-284852	StatementItem object (SALES-STI-2025-284852)	2	[{"changed": {"fields": ["Tax amount"]}}]	10	1
319	2025-03-31 11:38:20.058017+08	SALES-STM-2025-2cc7f2	Statement object (SALES-STM-2025-2cc7f2)	2	[{"changed": {"fields": ["Total amount", "Total tax"]}}]	7	1
320	2025-03-31 11:39:03.132847+08	SALES-STI-2025-2d5b9f	StatementItem object (SALES-STI-2025-2d5b9f)	2	[{"changed": {"fields": ["Unit price", "Total price", "Tax amount"]}}]	10	1
321	2025-03-31 11:39:56.337905+08	SALES-STM-2025-6b1653	Statement object (SALES-STM-2025-6b1653)	2	[{"changed": {"fields": ["Total amount", "Total tax"]}}]	7	1
322	2025-03-31 11:40:28.819285+08	SALES-STI-2025-b0fa0b	StatementItem object (SALES-STI-2025-b0fa0b)	2	[{"changed": {"fields": ["Unit price", "Total price", "Tax amount"]}}]	10	1
323	2025-03-31 17:51:11.445955+08	a	Payments object (a)	1	[{"added": {}}]	23	1
324	2025-03-31 17:52:01.69895+08	SALES-PAY-2025-9ab4c5	Payments object (SALES-PAY-2025-9ab4c5)	2	[]	23	1
325	2025-03-31 17:53:44.360391+08	SALES-INV-2025-0656dd	SalesInvoices object (SALES-INV-2025-0656dd)	2	[{"changed": {"fields": ["Payment status"]}}]	15	1
326	2025-03-31 17:56:02.147928+08	SALES-INV-2025-0656dd	SalesInvoices object (SALES-INV-2025-0656dd)	2	[{"changed": {"fields": ["Invoice date"]}}]	15	1
327	2025-03-31 17:58:47.896357+08	SALES-INV-2025-0656dd	SalesInvoices object (SALES-INV-2025-0656dd)	2	[{"changed": {"fields": ["Invoice date"]}}]	15	1
328	2025-04-01 09:59:40.982907+08	SALES-ORD-2025-d8c058	Order object (SALES-ORD-2025-d8c058)	2	[{"changed": {"fields": ["Goods issue"]}}]	13	1
329	2025-04-01 10:15:18.88301+08	a	ShipmentDetails object (a)	1	[{"added": {}}]	30	1
330	2025-04-01 10:21:17.990331+08	DIS-SC-2025-be47e9	ShippingCost object (DIS-SC-2025-be47e9)	2	[{"changed": {"fields": ["Packing list", "Cost per kg", "Cost per km", "Weight kg", "Distance km", "Total shipping cost"]}}]	31	1
331	2025-04-01 10:38:36.710217+08	SALES-SHIP-2025-488e6e	ShippingDetails object (SALES-SHIP-2025-488e6e)	2	[{"changed": {"fields": ["Shipment", "Tracking num", "Shipping date", "Estimated delivery", "Delivery status"]}}]	18	1
332	2025-04-01 10:56:06.080121+08	SALES-SHIP-2025-488e6e	ShippingDetails object (SALES-SHIP-2025-488e6e)	2	[]	18	1
333	2025-04-01 11:44:26.533012+08	SALES-ORD-2025-befd65	Order object (SALES-ORD-2025-befd65)	2	[{"changed": {"fields": ["Goods issue"]}}]	13	1
336	2025-04-01 12:38:49.945849+08	SALES-SHIP-2025-5acf4c	ShippingDetails object (SALES-SHIP-2025-5acf4c)	2	[{"changed": {"fields": ["Shipment"]}}]	18	1
337	2025-04-01 12:45:04.54426+08	SALES-SHIP-2025-5acf4c	ShippingDetails object (SALES-SHIP-2025-5acf4c)	2	[]	18	1
338	2025-04-01 12:49:20.803709+08	SALES-SHIP-2025-5acf4c	ShippingDetails object (SALES-SHIP-2025-5acf4c)	2	[]	18	1
339	2025-04-01 12:51:19.794927+08	SALES-SHIP-2025-5acf4c	ShippingDetails object (SALES-SHIP-2025-5acf4c)	2	[{"changed": {"fields": ["Delivery status"]}}]	18	1
\.
...
26	misc	policies
27	invoice	receipt
28	misc	externalprojectrequest
29	misc	goodsissue
30	misc	shipmentdetails
31	misc	shippingcost
\.
...
SALES-CONTACT-2025-0f900c	SALES-CMPGN-2025-a2fed5	Pending	SALES-CUST-2025-dbfe2c
SALES-CONTACT-2025-a5f5a9	SALES-CMPGN-2025-a2fed5	Pending	SALES-CUST-2025-df9ce6
SALES-CONTACT-2025-9614e5	SALES-CMPGN-2025-30dc07	Pending	SALES-CUST-2025-3197ba
SALES-CONTACT-2025-a5dc6c	SALES-CMPGN-2025-30dc07	Pending	SALES-CUST-2025-0294dc
...
COPY sales.campaigns (campaign_id, campaign_name, start_date, end_date, type) FROM stdin;
SALES-CMPGN-2025-59cd34	New Medical Equipment Launch	2025-04-01 08:00:00	2025-04-15 23:59:59	Email
SALES-CMPGN-2025-846658	Free Sample: Surgical Masks	2025-04-10 08:00:00	2025-04-20 23:59:59	Email
SALES-CMPGN-2025-e4d734	Healthcare Expo Invitation	2025-04-05 08:00:00	2025-04-25 23:59:59	Email
SALES-CMPGN-2025-871a35	New FDA-Approved Products	2025-02-10 08:00:00	2025-02-28 23:59:59	Email
SALES-CMPGN-2025-76996e	Emergency Medical Supplies Sale	2025-04-12 08:00:00	2025-04-22 23:59:59	Email
SALES-CMPGN-2025-78ce57	Medical Equipment Expo 2025	2025-05-01 08:00:00	2025-05-15 23:59:59	Email
SALES-CMPGN-2025-cc3288	Free Sample: Diagnostic Kits	2025-05-05 08:00:00	2025-05-20 23:59:59	Email
SALES-CMPGN-2025-30dc07	Emergency Supplies Discount	2025-05-12 08:00:00	2025-05-25 23:59:59	Email
SALES-CMPGN-2025-a2fed5	Healthcare Summit Invitation	2025-05-10 08:00:00	2025-05-30 23:59:59	Email
SALES-CMPGN-2025-f796df	Loyalty Program for Hospitals	2025-04-01 08:00:00	2025-04-30 23:59:59	Email
SALES-CMPGN-2025-59967a	Exclusive Offer: Lab Equipment	2025-04-15 08:00:00	2025-04-30 23:59:59	Email
SALES-CMPGN-2025-19cdfa	Pharmacy Discount Campaign	2025-04-10 08:00:00	2025-04-25 23:59:59	Email
SALES-CMPGN-2025-f3640c	New Product Launch: Ventilators	2025-03-20 08:00:00	2025-04-10 23:59:59	Email
SALES-CMPGN-2025-bb9272	Exclusive Discount for Clinics	2025-03-20 08:00:00	2025-04-05 23:59:59	Email
SALES-CMPGN-2025-c3bcdb	Healthcare Innovation Webinar	2025-03-25 08:00:00	2025-04-05 23:59:59	Email
SALES-CMPGN-2025-85634d	Loyalty Rewards for Pharmacies	2025-03-01 08:00:00	2025-03-31 23:59:59	Email
SALES-CMPGN-2025-3538c1	Exclusive Bulk Order Offer	2025-03-15 08:00:00	2025-03-30 23:59:59	Email
SALES-CMPGN-2025-056a95	Medical Compliance Training	2025-03-15 08:00:00	2025-03-25 23:59:59	Email
SALES-CMPGN-2025-a2fba8	Hospital Procurement Webinar	2025-03-10 08:00:00	2025-03-15 23:59:59	Email
SALES-CMPGN-2025-ff71e8	Medical Device Compliance Update	2025-02-20 08:00:00	2025-03-05 23:59:59	Email
SALES-CMPGN-2025-46bdd6	Loyalty Rewards for Clinics	2025-03-28 00:00:00	2025-04-05 00:00:00	Email
SALES-CMPGN-2025-587475	New Equipment 	2025-03-31 00:00:00	2025-04-02 00:00:00	Email
\.
...
SALES-CUST-2025-3802d4	ACC-GLA-2025-bd61fe	ADMIN-PARTNER-2025-84fcb0	Lung Center of America	sales@lcoa.com	09123456789	1000 Inglewood	California	Los Angeles	4000	United States	Client	Active	0.00	\N
\.
...
COPY sales.opportunities (opportunity_id, customer_id, partner_id, salesrep_id, estimated_value, expected_closed_date, stage, status, description, reason_lost, interest_level, weighted_amount, starting_date) FROM stdin;
SALES-OPP-2025-e9b6c4	SALES-CUST-2025-a6775c	ADMIN-PARTNER-2025-1c49e2	HR-EMP-2025-f0cffe	200000.00	2025-07-30	Closed	Won	Bulk order for surgical gloves and hospital beds.		\N	\N	2025-03-31 18:54:41.440567
SALES-OPP-2025-e1589d	SALES-CUST-2025-f7aa99	ADMIN-PARTNER-2025-fb5757	HR-EMP-2025-f0cffe	12000.00	2025-06-10	Negotiation	Open	Service maintenance contract for medical equipment.		\N	\N	2025-03-31 18:54:41.440567
SALES-OPP-2025-cf73e9	SALES-CUST-2025-6a3167	ADMIN-PARTNER-2025-6180de	HR-EMP-2025-b15e2f	150000.00	2025-04-20	Negotiation	Open	Negotiating pricing for ventilators.		\N	\N	2025-03-31 18:54:41.440567
SALES-OPP-2025-bcf781	SALES-CUST-2025-cbf858	ADMIN-PARTNER-2025-63fd8e	HR-EMP-2025-b15e2f	20000.00	2025-05-10	Closed	Won	Sold 200 syringes and 50 BP monitors.		\N	\N	2025-03-31 18:54:41.440567
SALES-OPP-2025-b98cab	SALES-CUST-2025-941d72	ADMIN-PARTNER-2025-bc6ec3	HR-EMP-2025-9e7313	600000.00	2025-08-01	Negotiation	Lost	Large order for ventilators.	Customer chose competitor.	\N	\N	2025-03-31 18:54:41.440567
SALES-OPP-2025-b26644	SALES-CUST-2025-3197ba	ADMIN-PARTNER-2025-7105fc	HR-EMP-2025-b15e2f	10000.00	2025-05-25	Closed	Lost	Small clinic interested in X-ray machine.	Budget constraints.	\N	\N	2025-03-31 18:54:41.440567
SALES-OPP-2025-a0bef8	SALES-CUST-2025-8cdccd	ADMIN-PARTNER-2025-3fed97	HR-EMP-2025-f0cffe	95000.00	2025-05-20	Prospecting	Open	Potential deal for 3 new dialysis machines.		\N	\N	2025-03-31 18:54:41.440567
SALES-OPP-2025-8570cd	SALES-CUST-2025-dbfe2c	ADMIN-PARTNER-2025-93d94d	HR-EMP-2025-b15e2f	180000.00	2025-06-30	Closed	Won	Bulk order for surgical gloves and hospital furniture.		\N	\N	2025-03-31 18:54:41.440567
SALES-OPP-2025-84846c	SALES-CUST-2025-a42491	ADMIN-PARTNER-2025-93d94d	HR-EMP-2025-9e7313	8000.00	2025-04-25	Closed	Lost	Small clinic interested in ECG machine.	Budget constraints.	\N	\N	2025-03-31 18:54:41.440567
SALES-OPP-2025-6ea508	SALES-CUST-2025-614801	ADMIN-PARTNER-2025-a665c4	HR-EMP-2025-9e7313	90000.00	2025-07-01	Prospecting	Open	New client interested in MRI machines.		\N	\N	2025-03-31 18:54:41.440567
SALES-OPP-2025-6e9fef	SALES-CUST-2025-b1576f	ADMIN-PARTNER-2025-a7e20d	HR-EMP-2025-b15e2f	250000.00	2025-05-15	Prospecting	Open	Potential MRI scanner bulk order for hospital.		\N	\N	2025-03-31 18:54:41.440567
SALES-OPP-2025-6e4bbf	SALES-CUST-2025-fbdaf0	ADMIN-PARTNER-2025-73d402	HR-EMP-2025-f0cffe	18000.00	2025-07-10	Negotiation	Open	Service maintenance contract for lab equipment.		\N	\N	2025-03-31 18:54:41.440567
SALES-OPP-2025-544114	SALES-CUST-2025-d105ee	ADMIN-PARTNER-2025-20fcd8	HR-EMP-2025-9e7313	110000.00	2025-06-20	Prospecting	Open	Potential deal for 5 new dialysis machines.		\N	\N	2025-03-31 18:54:41.440567
SALES-OPP-2025-524755	SALES-CUST-2025-cd1d37	ADMIN-PARTNER-2025-03bc88	HR-EMP-2025-f0cffe	25000.00	2025-06-10	Closed	Won	Sold 300 syringes and 100 BP monitors.		\N	\N	2025-03-31 18:54:41.440567
SALES-OPP-2025-2f8710	SALES-CUST-2025-59eb62	ADMIN-PARTNER-2025-257ac1	HR-EMP-2025-b15e2f	500000.00	2025-07-01	Negotiation	Lost	Large order for hospital beds.	Customer chose competitor.	\N	\N	2025-03-31 18:54:41.440567
SALES-OPP-2025-1f3caf	SALES-CUST-2025-0294dc	ADMIN-PARTNER-2025-29b3ed	HR-EMP-2025-b15e2f	15000.00	2025-04-30	Closed	Won	Sold 1000 surgical masks.		\N	\N	2025-03-31 18:54:41.440567
SALES-OPP-2025-1c1b9d	SALES-CUST-2025-2597c0	ADMIN-PARTNER-2025-87201f	HR-EMP-2025-b15e2f	10000.00	2025-03-30	Closed	Won	Sold 500 surgical gloves.		\N	\N	2025-03-31 18:54:41.440567
SALES-OPP-2025-168ce4	SALES-CUST-2025-2597c0	ADMIN-PARTNER-2025-4602bc	HR-EMP-2025-9e7313	300000.00	2025-06-15	Prospecting	Open	Potential deal for CT scanners.		\N	\N	2025-03-31 18:54:41.440567
SALES-OPP-2025-0456fe	SALES-CUST-2025-df9ce6	ADMIN-PARTNER-2025-ccfa60	HR-EMP-2025-f0cffe	120000.00	2025-05-20	Negotiation	Open	Negotiating pricing for ultrasound machines.		\N	\N	2025-03-31 18:54:41.440567
SALES-OPP-2025-041b10	SALES-CUST-2025-2ba07b	ADMIN-PARTNER-2025-6fc170	HR-EMP-2025-9e7313	75000.00	2025-06-01	Prospecting	Open	New client interested in defibrillators.		\N	\N	2025-03-31 18:54:41.440567
\.
...
SALES-ORD-2025-3d77ab	SALES-STM-2025-9bc446	SALES-QT-2025-0c2dc2	\N	\N	2025-03-28 06:00:55.951	Pending	1631959.02	Direct
SALES-ORD-2025-c6b85a	SALES-STM-2025-cfb093	\N	\N	\N	2025-03-30 04:25:50.057	Pending	632345.71	Direct
SALES-ORD-2025-63cc4b	SALES-STM-2025-6eb914	\N	\N	\N	2025-03-30 05:16:56.733	Pending	3354642.67	Direct
SALES-ORD-2025-4e474f	SALES-STM-2025-d2f2d7	\N	\N	\N	2025-03-30 06:18:49.447	Pending	790258.23	Direct
SALES-ORD-2025-3bfd38	SALES-STM-2025-453f7f	\N	\N	\N	2025-03-30 06:36:46.569	Pending	592128.75	Direct
SALES-ORD-2025-d690bb	SALES-STM-2025-ad7bdb	\N	\N	\N	2025-03-30 06:42:04.261	Pending	403611.95	Direct
SALES-ORD-2025-d6280a	SALES-STM-2025-22dcfc	SALES-QT-2025-56dfc5	\N	\N	2025-03-30 06:53:03.79	Pending	1359992.52	Direct
SALES-ORD-2025-f7f579	SALES-STM-2025-416e41	\N	\N	\N	2025-03-30 09:16:27.005	Pending	1958097.83	Direct
SALES-ORD-2025-de16af	SALES-STM-2025-99cde0	\N	\N	\N	2025-03-30 09:25:58.383	Pending	1300969.27	Direct
SALES-ORD-2025-ca30a5	SALES-STM-2025-9913de	SALES-QT-2025-cb96c7	\N	\N	2025-03-30 14:07:42.375	Pending	955213.16	Direct
SALES-ORD-2025-38c24e	SALES-STM-2025-8d6ddf	SALES-QT-2025-f7ff35	\N	\N	2025-03-30 14:25:02.858	Pending	263092.82	Direct
SALES-ORD-2025-d8c058	SALES-STM-2025-9a2b81	SALES-QT-2025-e7356b	\N	DIS-GI-2025-92c5e3	2025-03-31 09:34:00.046	Delivered	893390.47	Direct
SALES-ORD-2025-befd65	SALES-STM-2025-177b2a	SALES-QT-2025-56dfc5	\N	DIS-GI-2025-99fe95	2025-03-30 07:02:26.011	Delivered	1679830.12	Direct
SALES-ORD-2025-393647	SALES-STM-2025-4f9b8e	\N	\N	\N	\N	Shipped	1359992.52	Direct
\.
...
SALES-PAY-2025-9ab4c5	SALES-ORD-2025-d8c058	Bank Transfer	Completed	2025-03-31 09:51:10
\.
...
SALES-QT-2025-0c2dc2	SALES-STM-2025-b768c5	\N	2025-03-28 05:55:42.676	Approved
SALES-QT-2025-56dfc5	SALES-STM-2025-d2fe42	\N	2025-03-24 07:00:10.377	Approved
SALES-QT-2025-b88424	SALES-STM-2025-4aff81	\N	2025-03-30 09:16:16.776	Pending
SALES-QT-2025-ae686c	SALES-STM-2025-08e3f7	\N	2025-03-30 09:25:52.544	Pending
SALES-QT-2025-cb96c7	SALES-STM-2025-e40c3c	\N	2025-03-30 14:07:31.571	Approved
SALES-QT-2025-f7ff35	SALES-STM-2025-3112a4	\N	2025-03-30 14:24:57.959	Approved
SALES-QT-2025-e7356b	SALES-STM-2025-3b4cb0	\N	2025-03-31 09:33:22.967	Approved
\.
...
SALES-INV-2025-506fa3	SALES-ORD-2025-c6b85a	2025-03-30 04:25:50.117866	632345.71	Pending	Pending	2025-04-06
SALES-INV-2025-9e9229	SALES-ORD-2025-c6b85a	2025-03-30 12:47:24	632345.71	Pending	Pending	2025-03-31
SALES-INV-2025-cc2be5	SALES-ORD-2025-63cc4b	2025-03-30 05:16:56.7899	3354642.67	Pending	Pending	2025-04-06
SALES-INV-2025-d84354	SALES-ORD-2025-4e474f	2025-03-30 06:18:49.494605	790258.23	Pending	Pending	2025-04-06
SALES-INV-2025-637135	SALES-ORD-2025-3bfd38	2025-03-30 06:36:46.617114	592128.75	Pending	Pending	2025-04-06
SALES-INV-2025-7dd2a6	SALES-ORD-2025-d690bb	2025-03-30 06:42:04.309692	403611.95	Pending	Pending	2025-04-06
SALES-INV-2025-c8ee5c	SALES-ORD-2025-d6280a	2025-03-30 06:53:04.111641	1359992.52	Pending	Pending	2025-04-06
SALES-INV-2025-61e77d	SALES-ORD-2025-f7f579	2025-03-30 09:16:27.056088	1958097.83	Pending	Pending	2025-04-06
SALES-INV-2025-514c3f	SALES-ORD-2025-de16af	2025-03-30 09:25:58.430867	1300969.27	Pending	Pending	2025-04-06
SALES-INV-2025-570ce2	SALES-ORD-2025-ca30a5	2025-03-30 14:07:42.426183	955213.16	Pending	Pending	2025-04-06
SALES-INV-2025-9928d9	SALES-ORD-2025-38c24e	2025-03-30 14:25:02.906798	263092.82	Pending	Pending	2025-04-06
SALES-INV-2025-0656dd	SALES-ORD-2025-d8c058	2025-03-31 09:34:00	893390.47	Paid	Completed	2025-04-07
SALES-INV-2025-38f50b	SALES-ORD-2025-befd65	2025-03-30 07:02:26.063624	1681630.12	Pending	Pending	2025-04-06
SALES-INV-2025-d40757	SALES-ORD-2025-393647	2025-04-01 04:32:33.080877	1362092.52	Pending	Pending	2025-04-08
\.
...
SALES-SHIP-2025-a58127	SALES-ORD-2025-ca30a5	\N	\N	Standard	TRK-153964	\N	2025-04-02 00:00:00	Pending	\N	\N
SALES-SHIP-2025-f4bf8a	SALES-ORD-2025-ca30a5	\N	\N	Standard	TRK-618F4F	\N	2025-04-02 00:00:00	Pending	\N	\N
SALES-SHIP-2025-6bfb3f	SALES-ORD-2025-ca30a5	\N	\N	Standard	TRK-8E1460	\N	2025-04-02 00:00:00	Pending	\N	\N
SALES-SHIP-2025-5ae60e	SALES-ORD-2025-38c24e	\N	\N	Standard	TRK-A6DC4B	\N	2025-04-02 00:00:00	Pending	SALES-STM-2025-b98977	\N
SALES-SHIP-2025-9dccdd	SALES-ORD-2025-d8c058	\N	\N	Standard	TRK-51033B	\N	2025-04-03 00:00:00	Delivered	SALES-STM-2025-150ad6	\N
SALES-SHIP-2025-c4bada	SALES-ORD-2025-befd65	\N	\N	Standard	TRK-CA5B85	\N	2025-04-02 00:00:00	Delivered	\N	\N
SALES-SHIP-2025-488e6e	SALES-ORD-2025-befd65	\N	DIS-BR-2025-64b6a8	Standard	TRK-1234	2025-04-02 02:14:51	2025-04-04 02:14:51	Delivered	\N	\N
SALES-SHIP-2025-5acf4c	SALES-ORD-2025-393647	\N	DIS-BR-2025-4a6596	Standard	\N	\N	2025-04-04 00:00:00	Shipped	SALES-STM-2025-4f9b8e	\N
\.
...
COPY sales.statement (statement_id, customer_id, salesrep_id, total_amount, discount, type, total_tax, ext_project_request_id) FROM stdin;
SALES-STM-2025-29deb9	SALES-CUST-2025-2ba07b	HR-EMP-2025-9e7313	0.00	0.00	Non-Project-Based	0.00	\N
SALES-STM-2025-3656cd	SALES-CUST-2025-641c4a	HR-EMP-2025-b15e2f	124063.19	0.00	Non-Project-Based	12173.00	\N
SALES-STM-2025-a29318	SALES-CUST-2025-6a3167	HR-EMP-2025-9e7313	9782.61	0.00	Non-Project-Based	943.00	\N
SALES-STM-2025-d8e83d	SALES-CUST-2025-f7aa99	HR-EMP-2025-f0cffe	192419.90	5298.00	Non-Project-Based	19428.00	\N
SALES-STM-2025-bad08f	SALES-CUST-2025-614801	HR-EMP-2025-f0cffe	192419.90	5298.00	Non-Project-Based	19428.00	\N
SALES-STM-2025-aab12b	SALES-CUST-2025-cd1d37	HR-EMP-2025-f0cffe	273499.52	0.00	Non-Project-Based	26882.00	\N
SALES-STM-2025-2d9ae3	SALES-CUST-2025-641c4a	HR-EMP-2025-9e7313	1051.60	0.00	Non-Project-Based	94.00	\N
SALES-STM-2025-ce174e	SALES-CUST-2025-d105ee	HR-EMP-2025-f0cffe	1431779.48	0.00	Non-Project-Based	140801.00	\N
SALES-STM-2025-a862da	SALES-CUST-2025-a6775c	HR-EMP-2025-f0cffe	379994.11	0.00	Non-Project-Based	37347.00	\N
SALES-STM-2025-45b669	SALES-CUST-2025-3f84fe	HR-EMP-2025-b15e2f	23309.69	0.00	Non-Project-Based	2263.00	\N
SALES-STM-2025-6b3b58	SALES-CUST-2025-3f84fe	HR-EMP-2025-b15e2f	23309.69	0.00	Non-Project-Based	2263.00	\N
SALES-STM-2025-6b3ff1	SALES-CUST-2025-3197ba	HR-EMP-2025-9e7313	2398661.30	19999.00	Non-Project-Based	237842.00	\N
SALES-STM-2025-d2fe42	SALES-CUST-2025-f7aa99	HR-EMP-2025-f0cffe	1359992.52	0.00	Non-Project-Based	133760.00	\N
SALES-STM-2025-0a7cb9	SALES-CUST-2025-cbf858	HR-EMP-2025-b15e2f	25898.04	0.00	Non-Project-Based	2518.00	\N
SALES-STM-2025-3acfef	SALES-CUST-2025-d105ee	HR-EMP-2025-b15e2f	316742.99	0.00	Non-Project-Based	31145.00	\N
SALES-STM-2025-91058d	SALES-CUST-2025-3197ba	HR-EMP-2025-9e7313	266548.00	0.00	Non-Project-Based	26208.00	\N
SALES-STM-2025-251924	SALES-CUST-2025-a6775c	HR-EMP-2025-f0cffe	164779.50	0.00	Non-Project-Based	17182.00	\N
SALES-STM-2025-21f5af	SALES-CUST-2025-fbdaf0	HR-EMP-2025-b15e2f	316742.99	15000.00	Project-Based	31145.00	\N
SALES-STM-2025-f6b7d0	SALES-CUST-2025-a6775c	HR-EMP-2025-f0cffe	704946.16	25000.00	Non-Project-Based	71788.00	\N
SALES-STM-2025-16fb8a	SALES-CUST-2025-59eb62	HR-EMP-2025-b15e2f	0.00	0.00	Project-Based	0.00	\N
SALES-STM-2025-2079b3	SALES-CUST-2025-f7aa99	HR-EMP-2025-cb0e4c	157114.00	0.00	Non-Project-Based	15444.00	\N
SALES-STM-2025-b768c5	SALES-CUST-2025-a42491	HR-EMP-2025-9e7313	1631959.02	12.00	Non-Project-Based	160512.00	\N
SALES-STM-2025-9bc446	SALES-CUST-2025-a42491	HR-EMP-2025-9e7313	1631959.02	12.00	Non-Project-Based	160512.00	\N
SALES-STM-2025-cfb093	SALES-CUST-2025-d105ee	HR-EMP-2025-f0cffe	632345.71	0.00	Non-Project-Based	62119.00	\N
SALES-STM-2025-6eb914	SALES-CUST-2025-d105ee	HR-EMP-2025-f0cffe	3354642.67	0.00	Non-Project-Based	329788.00	\N
SALES-STM-2025-d2f2d7	SALES-CUST-2025-d105ee	HR-EMP-2025-f0cffe	790258.23	0.00	Non-Project-Based	77671.00	\N
SALES-STM-2025-453f7f	SALES-CUST-2025-d105ee	HR-EMP-2025-f0cffe	592128.75	0.00	Non-Project-Based	58193.00	\N
SALES-STM-2025-ad7bdb	SALES-CUST-2025-d105ee	HR-EMP-2025-f0cffe	403611.95	0.00	Non-Project-Based	39660.00	\N
SALES-STM-2025-22dcfc	SALES-CUST-2025-f7aa99	HR-EMP-2025-f0cffe	1359992.52	0.00	Non-Project-Based	133760.00	\N
SALES-STM-2025-177b2a	SALES-CUST-2025-f7aa99	HR-EMP-2025-f0cffe	1679830.12	0.00	Non-Project-Based	165210.00	\N
SALES-STM-2025-6b1653	SALES-CUST-2025-dbfe2c	HR-EMP-2025-b15e2f	188516.80	0.00	Non-Project-Based	18533.00	\N
SALES-STM-2025-4aff81	SALES-CUST-2025-941d72	HR-EMP-2025-9e7313	1958097.83	0.00	Non-Project-Based	192570.00	\N
SALES-STM-2025-416e41	SALES-CUST-2025-941d72	HR-EMP-2025-9e7313	1958097.83	0.00	Non-Project-Based	192570.00	\N
SALES-STM-2025-08e3f7	SALES-CUST-2025-f7aa99	HR-EMP-2025-b15e2f	1300969.27	0.00	Non-Project-Based	127925.00	\N
SALES-STM-2025-99cde0	SALES-CUST-2025-f7aa99	HR-EMP-2025-b15e2f	1300969.27	0.00	Non-Project-Based	127925.00	\N
SALES-STM-2025-0de2f8	SALES-CUST-2025-f7aa99	HR-EMP-2025-f0cffe	2140325.42	0.00	Non-Project-Based	210494.00	\N
SALES-STM-2025-e4c3a7	SALES-CUST-2025-f7aa99	HR-EMP-2025-f0cffe	2140325.42	0.00	Non-Project-Based	210494.00	\N
SALES-STM-2025-e40c3c	SALES-CUST-2025-cd1d37	HR-EMP-2025-9e7313	955213.16	0.00	Non-Project-Based	93896.00	\N
SALES-STM-2025-9913de	SALES-CUST-2025-cd1d37	HR-EMP-2025-9e7313	955213.16	0.00	Non-Project-Based	93896.00	\N
SALES-STM-2025-54405e	SALES-CUST-2025-cd1d37	HR-EMP-2025-9e7313	955213.16	0.00	Non-Project-Based	93896.00	\N
SALES-STM-2025-9ced92	SALES-CUST-2025-cd1d37	HR-EMP-2025-9e7313	955213.16	0.00	Non-Project-Based	93896.00	\N
SALES-STM-2025-7d1648	SALES-CUST-2025-cd1d37	HR-EMP-2025-9e7313	955213.16	0.00	Non-Project-Based	93896.00	\N
SALES-STM-2025-750b00	SALES-CUST-2025-d105ee	HR-EMP-2025-f0cffe	1951808.62	0.00	Non-Project-Based	191962.00	\N
SALES-STM-2025-3112a4	SALES-CUST-2025-941d72	HR-EMP-2025-9e7313	263092.82	0.00	Non-Project-Based	25858.00	\N
SALES-STM-2025-8d6ddf	SALES-CUST-2025-941d72	HR-EMP-2025-9e7313	263092.82	0.00	Non-Project-Based	25858.00	\N
SALES-STM-2025-b98977	SALES-CUST-2025-941d72	HR-EMP-2025-9e7313	263092.82	0.00	Non-Project-Based	25858.00	\N
SALES-STM-2025-c86ce6	SALES-CUST-2025-6a3167	HR-EMP-2025-cb0e4c	3272163.87	0.00	Non-Project-Based	321833.00	\N
SALES-STM-2025-f4b14f	SALES-CUST-2025-a6775c	HR-EMP-2025-b15e2f	371933.60	5000.00	Project-Based	37066.00	\N
SALES-STM-2025-656095	SALES-CUST-2025-a42491	HR-EMP-2025-9e7313	69971.81	0.00	Project-Based	6873.00	\N
SALES-STM-2025-948f52	SALES-CUST-2025-941d72	HR-EMP-2025-b15e2f	376933.60	0.00	Non-Project-Based	37066.00	\N
SALES-STM-2025-2f3fae	SALES-CUST-2025-a42491	HR-EMP-2025-f0cffe	4745.52	0.00	Non-Project-Based	1139.00	\N
SALES-STM-2025-35c700	SALES-CUST-2025-2597c0	HR-EMP-2025-9e7313	188516.80	0.00	Non-Project-Based	18533.00	\N
SALES-STM-2025-2879fa	SALES-CUST-2025-b1576f	HR-EMP-2025-f0cffe	188129.49	10000.00	Non-Project-Based	19478.00	\N
SALES-STM-2025-600a2f	SALES-CUST-2025-a6775c	HR-EMP-2025-f0cffe	32165.12	0.00	Non-Project-Based	3154.00	\N
SALES-STM-2025-b90b4b	SALES-CUST-2025-cbf858	HR-EMP-2025-f0cffe	320237.27	0.00	Project-Based	31489.00	\N
SALES-STM-2025-755417	SALES-CUST-2025-8cdccd	HR-EMP-2025-f0cffe	1325055.58	0.00	Non-Project-Based	130314.00	\N
SALES-STM-2025-5e569c	SALES-CUST-2025-614801	HR-EMP-2025-f0cffe	69971.81	0.00	Non-Project-Based	6873.00	\N
SALES-STM-2025-2cc7f2	SALES-CUST-2025-fbdaf0	HR-EMP-2025-f0cffe	380071.60	0.00	Project-Based	37374.00	\N
SALES-STM-2025-3b4cb0	SALES-CUST-2025-3802d4	HR-EMP-2025-b15e2f	925389.47	0.00	Non-Project-Based	90982.57	\N
SALES-STM-2025-9a2b81	SALES-CUST-2025-3802d4	HR-EMP-2025-b15e2f	893390.47	31999.00	Non-Project-Based	90982.57	\N
SALES-STM-2025-150ad6	SALES-CUST-2025-3802d4	HR-EMP-2025-b15e2f	893390.47	31999.00	Non-Project-Based	90982.57	\N
SALES-STM-2025-6e5388	SALES-CUST-2025-3802d4	HR-EMP-2025-9e7313	1359992.52	0.00	Non-Project-Based	133759.92	\N
SALES-STM-2025-0ada9a	SALES-CUST-2025-0294dc	HR-EMP-2025-9e7313	1359992.52	0.00	Non-Project-Based	133759.92	\N
SALES-STM-2025-07c8ee	SALES-CUST-2025-3f84fe	HR-EMP-2025-b15e2f	13460.46	0.00	Non-Project-Based	1314.14	\N
SALES-STM-2025-4f9b8e	SALES-CUST-2025-dbfe2c	HR-EMP-2025-9e7313	1359992.52	0.00	Non-Project-Based	133759.92	\N
\.
...
COPY sales.statement_item (statement_item_id, statement_id, sales_costing_id, product_id, item_md_id, quantity, unit_price, total_price, discount, tax_amount, return_reason, return_action, created_at, additional_service_id, renewal_id) FROM stdin;
SALES-STI-2025-fc3bec	SALES-STM-2025-251924	\N	ADMIN-PROD-2025-2e0ab6	\N	3	47726.64	150361.51	10000.00	17182	\N	\N	2025-03-28 13:52:49.605294	\N	\N
SALES-STI-2025-ca65f6	SALES-STM-2025-91058d	\N	ADMIN-PROD-2025-941c5b	\N	1	218400.00	218400.00	0.00	26208	\N	\N	2025-03-28 13:52:49.605294	\N	\N
SALES-STI-2025-6d5466	SALES-STM-2025-2d9ae3	\N	ADMIN-PROD-2025-91b19e	\N	1	780.00	780.00	0.00	0	\N	\N	2025-03-28 13:52:49.605294	\N	\N
SALES-STI-2025-b05e8b	SALES-STM-2025-ce174e	\N	ADMIN-PROD-2025-8698b7	\N	1	1114666.00	1114666.00	0.00	133760	\N	\N	2025-03-28 13:52:49.605294	\N	\N
SALES-STI-2025-b3d4b5	SALES-STM-2025-ce174e	\N	ADMIN-PROD-2025-5598cf	\N	1	10951.20	10951.20	0.00	1314	\N	\N	2025-03-28 13:52:49.605294	\N	\N
SALES-STI-2025-525ef8	SALES-STM-2025-f6b7d0	\N	ADMIN-PROD-2025-a68481	\N	1	598234.55	598234.55	25000.00	71788	\N	\N	2025-03-28 13:52:49.605294	\N	\N
SALES-STI-2025-2c497f	SALES-STM-2025-ce174e	\N	ADMIN-PROD-2025-2e0ab6	\N	1	47726.64	47726.64	0.00	5727	\N	\N	2025-03-28 13:52:49.605294	\N	\N
SALES-STI-2025-8e7958	SALES-STM-2025-a862da	\N	ADMIN-PROD-2025-9e365c	\N	1	3954.60	3954.60	0.00	0	\N	\N	2025-03-28 13:52:49.605294	\N	\N
SALES-STI-2025-8b38ca	SALES-STM-2025-a862da	\N	ADMIN-PROD-2025-2e0ab6	\N	1	47726.64	47726.64	0.00	0	\N	\N	2025-03-28 13:52:49.605294	\N	\N
SALES-STI-2025-c0aea0	SALES-STM-2025-a862da	\N	ADMIN-PROD-2025-a68481	\N	1	259543.44	259543.44	0.00	0	\N	\N	2025-03-28 13:52:49.605294	\N	\N
SALES-STI-2025-22397f	SALES-STM-2025-3acfef	\N	ADMIN-PROD-2025-115147	\N	1	259543.44	259543.44	0.00	31145	\N	\N	2025-03-28 13:52:49.605294	\N	\N
SALES-STI-2025-151818	SALES-STM-2025-21f5af	\N	ADMIN-PROD-2025-a68481	\N	1	259543.44	259543.44	0.00	31145	\N	\N	2025-03-28 13:52:49.605294	\N	\N
SALES-STI-2025-2e17d5	SALES-STM-2025-a29318	\N	ADMIN-PROD-2025-51838d	\N	1	3900.00	3900.00	0.00	0	\N	\N	2025-03-28 13:52:49.605294	\N	\N
SALES-STI-2025-0ad966	SALES-STM-2025-a29318	\N	ADMIN-PROD-2025-6db12d	\N	1	3954.60	3954.60	0.00	0	\N	\N	2025-03-28 13:52:49.605294	\N	\N
SALES-STI-2025-7607cb	SALES-STM-2025-d8e83d	\N	ADMIN-PROD-2025-2e0ab6	\N	3	47726.64	143179.92	4999.00	17182	\N	\N	2025-03-28 13:52:49.605294	\N	\N
SALES-STI-2025-bf3642	SALES-STM-2025-d8e83d	\N	ADMIN-PROD-2025-64c17b	\N	10	1872.00	18720.00	299.00	2246	\N	\N	2025-03-28 13:52:49.605294	\N	\N
SALES-STI-2025-64166b	SALES-STM-2025-bad08f	\N	ADMIN-PROD-2025-2e0ab6	\N	3	47726.64	143179.92	4999.00	17182	\N	\N	2025-03-28 13:52:49.605294	\N	\N
SALES-STI-2025-e38383	SALES-STM-2025-bad08f	\N	ADMIN-PROD-2025-64c17b	\N	10	1872.00	18720.00	299.00	2246	\N	\N	2025-03-28 13:52:49.605294	\N	\N
SALES-STI-2025-6e081d	SALES-STM-2025-aab12b	\N	ADMIN-PROD-2025-b39c24	\N	1	5616.00	5616.00	0.00	0	\N	\N	2025-03-28 13:52:49.605294	\N	\N
SALES-STI-2025-87f0c8	SALES-STM-2025-aab12b	\N	ADMIN-PROD-2025-941c5b	\N	1	218400.00	218400.00	0.00	0	\N	\N	2025-03-28 13:52:49.605294	\N	\N
SALES-STI-2025-3927cc	SALES-STM-2025-3656cd	\N	ADMIN-PROD-2025-66eb2d	\N	25	834.60	20865.00	0.00	2504	\N	\N	2025-03-28 13:52:49.605294	\N	\N
SALES-STI-2025-17e55f	SALES-STM-2025-3656cd	\N	ADMIN-PROD-2025-5598cf	\N	3	10951.20	32853.60	0.00	3942	\N	\N	2025-03-28 13:52:49.605294	\N	\N
SALES-STI-2025-dec340	SALES-STM-2025-3656cd	\N	ADMIN-PROD-2025-2e0ab6	\N	1	47726.64	47726.64	0.00	5727	\N	\N	2025-03-28 13:52:49.605294	\N	\N
SALES-STI-2025-0264ae	SALES-STM-2025-45b669	\N	ADMIN-PROD-2025-5598cf	\N	1	10951.20	10951.20	0.00	0	\N	\N	2025-03-28 13:52:49.605294	\N	\N
SALES-STI-2025-af888a	SALES-STM-2025-45b669	\N	ADMIN-PROD-2025-5833b2	\N	1	3954.60	3954.60	0.00	0	\N	\N	2025-03-28 13:52:49.605294	\N	\N
SALES-STI-2025-f0e0d5	SALES-STM-2025-45b669	\N	ADMIN-PROD-2025-6db12d	\N	1	3954.60	3954.60	0.00	0	\N	\N	2025-03-28 13:52:49.605294	\N	\N
SALES-STI-2025-c71430	SALES-STM-2025-6b3b58	\N	ADMIN-PROD-2025-5598cf	\N	1	10951.20	10951.20	0.00	0	\N	\N	2025-03-28 13:52:49.605294	\N	\N
SALES-STI-2025-07846b	SALES-STM-2025-6b3b58	\N	ADMIN-PROD-2025-5833b2	\N	1	3954.60	3954.60	0.00	0	\N	\N	2025-03-28 13:52:49.605294	\N	\N
SALES-STI-2025-f89340	SALES-STM-2025-6b3b58	\N	ADMIN-PROD-2025-6db12d	\N	1	3954.60	3954.60	0.00	0	\N	\N	2025-03-28 13:52:49.605294	\N	\N
SALES-STI-2025-f4d6fb	SALES-STM-2025-6b3ff1	\N	ADMIN-PROD-2025-8698b7	\N	1	1114666.00	1114666.00	19999.00	133760	\N	\N	2025-03-28 13:52:49.605294	\N	\N
SALES-STI-2025-fd4752	SALES-STM-2025-6b3ff1	\N	ADMIN-PROD-2025-a17047	\N	1	249756.00	249756.00	0.00	29971	\N	\N	2025-03-28 13:52:49.605294	\N	\N
SALES-STI-2025-a9fd57	SALES-STM-2025-6b3ff1	\N	ADMIN-PROD-2025-941c5b	\N	1	218400.00	218400.00	0.00	26208	\N	\N	2025-03-28 13:52:49.605294	\N	\N
SALES-STI-2025-cfc87c	SALES-STM-2025-6b3ff1	\N	ADMIN-PROD-2025-5598cf	\N	1	10951.20	10951.20	0.00	1314	\N	\N	2025-03-28 13:52:49.605294	\N	\N
SALES-STI-2025-8cd924	SALES-STM-2025-6b3ff1	\N	ADMIN-PROD-2025-83adb5	\N	1	128700.00	128700.00	0.00	0	\N	\N	2025-03-28 13:52:49.605294	\N	\N
SALES-STI-2025-0a29b6	SALES-STM-2025-6b3ff1	\N	ADMIN-PROD-2025-a68481	\N	1	259543.44	259543.44	0.00	0	\N	\N	2025-03-28 13:52:49.605294	\N	\N
SALES-STI-2025-40bb55	SALES-STM-2025-d2fe42	\N	ADMIN-PROD-2025-8698b7	\N	1	1114666.00	1114666.00	0.00	0	\N	\N	2025-03-28 13:52:49.605294	\N	\N
SALES-STI-2025-853877	SALES-STM-2025-0a7cb9	\N	ADMIN-PROD-2025-5598cf	\N	1	10951.20	10951.20	0.00	0	\N	\N	2025-03-28 13:52:49.605294	\N	\N
SALES-STI-2025-566a1d	SALES-STM-2025-0a7cb9	\N	ADMIN-PROD-2025-6db12d	\N	1	3954.60	3954.60	0.00	0	\N	\N	2025-03-28 13:52:49.605294	\N	\N
SALES-STI-2025-052cf9	SALES-STM-2025-0a7cb9	\N	ADMIN-PROD-2025-290b77	\N	1	6076.20	6076.20	0.00	0	\N	\N	2025-03-28 13:52:49.605294	\N	\N
SALES-STI-2025-7d4788	SALES-STM-2025-2079b3	\N	ADMIN-PROD-2025-115147	\N	1	128700.00	154440.00	0.00	0	\N	\N	2025-03-28 13:52:49.605294	\N	\N
SALES-STI-2025-f090bb	SALES-STM-2025-c86ce6	\N	ADMIN-PROD-2025-09e33a	\N	1	6739.20	7547.90	0.00	809		\N	2025-03-28 13:52:49	\N	\N
SALES-STI-2025-0361bc	SALES-STM-2025-c86ce6	\N	ADMIN-PROD-2025-8698b7	\N	2	1337599.20	2996222.21	0.00	321024		\N	2025-03-28 13:52:49	\N	\N
SALES-STI-2025-a09a62	SALES-STM-2025-f4b14f	\N	ADMIN-PROD-2025-83adb5	\N	2	154440.00	340945.60	5000.00	37066		\N	2025-03-28 13:52:49	\N	\N
SALES-STI-2025-6e1e9d	SALES-STM-2025-656095	\N	ADMIN-PROD-2025-2e0ab6	\N	1	57271.97	64144.61	0.00	6873		\N	2025-03-28 13:52:49	\N	\N
SALES-STI-2025-87ad28	SALES-STM-2025-948f52	\N	ADMIN-PROD-2025-115147	\N	2	154440.00	345945.60	0.00	37066		\N	2025-03-28 13:52:49	\N	\N
SALES-STI-2025-262ddf	SALES-STM-2025-2f3fae	\N	ADMIN-PROD-2025-0e6337	\N	2	4745.52	10629.96	0.00	1139		\N	2025-03-28 13:52:49	\N	\N
SALES-STI-2025-391666	SALES-STM-2025-35c700	\N	ADMIN-PROD-2025-83adb5	\N	1	154440.00	172972.80	0.00	18533		\N	2025-03-28 13:52:49	\N	\N
SALES-STI-2025-0501db	SALES-STM-2025-2879fa	\N	ADMIN-PROD-2025-c5c83a	\N	1	162319.25	171797.56	10000.00	19478		\N	2025-03-28 13:52:49	\N	\N
SALES-STI-2025-fbdf4d	SALES-STM-2025-600a2f	\N	ADMIN-PROD-2025-5598cf	\N	2	13141.44	29436.83	0.00	3154		\N	2025-03-28 13:52:49	\N	\N
SALES-STI-2025-900021	SALES-STM-2025-b90b4b	\N	ADMIN-PROD-2025-b022f3	\N	1	262407.60	293896.51	0.00	31489		\N	2025-03-28 13:52:49	\N	\N
SALES-STI-2025-c956cf	SALES-STM-2025-755417	\N	ADMIN-PROD-2025-a17047	\N	1	299707.20	335672.06	0.00	35965		\N	2025-03-28 13:52:49	\N	\N
SALES-STI-2025-b58f6a	SALES-STM-2025-755417	\N	ADMIN-PROD-2025-941c5b	\N	3	262080.00	880588.80	0.00	94349		\N	2025-03-28 13:52:49	\N	\N
SALES-STI-2025-2d5b9f	SALES-STM-2025-2cc7f2	\N	ADMIN-PROD-2025-a68481	\N	1	311452.13	348826.39	0.00	37374		\N	2025-03-28 13:52:49	\N	\N
SALES-STI-2025-b0fa0b	SALES-STM-2025-6b1653	\N	ADMIN-PROD-2025-115147	\N	1	154440.00	172972.80	0.00	18533		\N	2025-03-28 13:52:49	\N	\N
SALES-STI-2025-9be1d9	SALES-STM-2025-b768c5	\N	ADMIN-PROD-2025-8698b7	\N	1	1337599.20	1337599.20	12.00	160512	\N	\N	2025-03-28 05:55:42.722147	\N	\N
SALES-STI-2025-02bbf4	SALES-STM-2025-9bc446	\N	ADMIN-PROD-2025-8698b7	\N	1	1337599.20	1337599.20	12.00	160512	\N	\N	2025-03-28 06:00:56.111869	\N	\N
SALES-STI-2025-8f4c9a	SALES-STM-2025-cfb093	\N	ADMIN-PROD-2025-5598cf	\N	1	13141.44	13141.44	0.00	0	\N	\N	2025-03-30 04:25:49.51457	\N	\N
SALES-STI-2025-b4c4ac	SALES-STM-2025-cfb093	\N	ADMIN-PROD-2025-467bbd	\N	1	12907.44	12907.44	0.00	0	\N	\N	2025-03-30 04:25:49.51457	\N	\N
SALES-STI-2025-745ac0	SALES-STM-2025-cfb093	\N	ADMIN-PROD-2025-941c5b	\N	1	262080.00	262080.00	0.00	0	\N	\N	2025-03-30 04:25:49.51457	\N	\N
SALES-STI-2025-e7b05f	SALES-STM-2025-cfb093	\N	ADMIN-PROD-2025-64c17b	\N	1	2246.40	2246.40	0.00	0	\N	\N	2025-03-30 04:25:49.51457	\N	\N
SALES-STI-2025-c52635	SALES-STM-2025-cfb093	\N	ADMIN-PROD-2025-93544e	\N	1	2948.40	2948.40	0.00	0	\N	\N	2025-03-30 04:25:49.51457	\N	\N
SALES-STI-2025-51a58f	SALES-STM-2025-cfb093	\N	ADMIN-PROD-2025-1c041d	\N	1	4745.52	4745.52	0.00	0	\N	\N	2025-03-30 04:25:49.51457	\N	\N
SALES-STI-2025-77439f	SALES-STM-2025-cfb093	\N	ADMIN-PROD-2025-2e0ab6	\N	1	57271.97	57271.97	0.00	0	\N	\N	2025-03-30 04:25:49.51457	\N	\N
SALES-STI-2025-c5c61b	SALES-STM-2025-cfb093	\N	ADMIN-PROD-2025-c5c83a	\N	1	162319.25	162319.25	0.00	0	\N	\N	2025-03-30 04:25:49.51457	\N	\N
SALES-STI-2025-dfa140	SALES-STM-2025-6eb914	\N	ADMIN-PROD-2025-5598cf	\N	1	13141.44	13141.44	0.00	0	\N	\N	2025-03-30 05:15:39.775804	\N	\N
SALES-STI-2025-a4ea45	SALES-STM-2025-6eb914	\N	ADMIN-PROD-2025-467bbd	\N	1	12907.44	12907.44	0.00	0	\N	\N	2025-03-30 05:15:39.775804	\N	\N
SALES-STI-2025-e6a76b	SALES-STM-2025-6eb914	\N	ADMIN-PROD-2025-941c5b	\N	1	262080.00	262080.00	0.00	0	\N	\N	2025-03-30 05:15:39.775804	\N	\N
SALES-STI-2025-3bc6d6	SALES-STM-2025-6eb914	\N	ADMIN-PROD-2025-64c17b	\N	1	2246.40	2246.40	0.00	0	\N	\N	2025-03-30 05:15:39.775804	\N	\N
SALES-STI-2025-209358	SALES-STM-2025-6eb914	\N	ADMIN-PROD-2025-93544e	\N	1	2948.40	2948.40	0.00	0	\N	\N	2025-03-30 05:15:39.775804	\N	\N
SALES-STI-2025-b55d38	SALES-STM-2025-6eb914	\N	ADMIN-PROD-2025-1c041d	\N	1	4745.52	4745.52	0.00	0	\N	\N	2025-03-30 05:15:39.775804	\N	\N
SALES-STI-2025-35c6de	SALES-STM-2025-6eb914	\N	ADMIN-PROD-2025-2e0ab6	\N	1	57271.97	57271.97	0.00	0	\N	\N	2025-03-30 05:15:39.775804	\N	\N
SALES-STI-2025-f28225	SALES-STM-2025-6eb914	\N	ADMIN-PROD-2025-c5c83a	\N	1	162319.25	162319.25	0.00	0	\N	\N	2025-03-30 05:15:39.775804	\N	\N
SALES-STI-2025-02a935	SALES-STM-2025-6eb914	\N	ADMIN-PROD-2025-66eb2d	\N	1	1001.52	1001.52	0.00	0	\N	\N	2025-03-30 05:15:39.775804	\N	\N
SALES-STI-2025-a47bd0	SALES-STM-2025-6eb914	\N	ADMIN-PROD-2025-a17047	\N	1	299707.20	299707.20	0.00	0	\N	\N	2025-03-30 05:15:39.775804	\N	\N
SALES-STI-2025-443416	SALES-STM-2025-6eb914	\N	ADMIN-PROD-2025-158fce	\N	1	4745.52	4745.52	0.00	0	\N	\N	2025-03-30 05:15:39.775804	\N	\N
SALES-STI-2025-d57260	SALES-STM-2025-6eb914	\N	ADMIN-PROD-2025-83adb5	\N	1	154440.00	154440.00	0.00	0	\N	\N	2025-03-30 05:15:39.775804	\N	\N
SALES-STI-2025-82a73a	SALES-STM-2025-6eb914	\N	ADMIN-PROD-2025-115147	\N	1	154440.00	154440.00	0.00	0	\N	\N	2025-03-30 05:15:39.775804	\N	\N
SALES-STI-2025-cf6904	SALES-STM-2025-6eb914	\N	ADMIN-PROD-2025-09e33a	\N	1	6739.20	6739.20	0.00	0	\N	\N	2025-03-30 05:15:39.775804	\N	\N
SALES-STI-2025-0ee92e	SALES-STM-2025-6eb914	\N	ADMIN-PROD-2025-8698b7	\N	1	1337599.20	1337599.20	0.00	0	\N	\N	2025-03-30 05:15:39.775804	\N	\N
SALES-STI-2025-fe3ece	SALES-STM-2025-6eb914	\N	ADMIN-PROD-2025-b022f3	\N	1	262407.60	262407.60	0.00	0	\N	\N	2025-03-30 05:15:39.775804	\N	\N
SALES-STI-2025-b6aa71	SALES-STM-2025-6eb914	\N	ADMIN-PROD-2025-f4dfb1	\N	1	4745.52	4745.52	0.00	0	\N	\N	2025-03-30 05:15:39.775804	\N	\N
SALES-STI-2025-31cbac	SALES-STM-2025-6eb914	\N	ADMIN-PROD-2025-6db12d	\N	1	4745.52	4745.52	0.00	0	\N	\N	2025-03-30 05:15:39.775804	\N	\N
SALES-STI-2025-e06351	SALES-STM-2025-d2f2d7	\N	ADMIN-PROD-2025-5598cf	\N	1	13141.44	13141.44	0.00	0	\N	\N	2025-03-30 06:17:26.333539	\N	\N
SALES-STI-2025-7c263d	SALES-STM-2025-d2f2d7	\N	ADMIN-PROD-2025-467bbd	\N	1	12907.44	12907.44	0.00	0	\N	\N	2025-03-30 06:17:26.333539	\N	\N
SALES-STI-2025-059568	SALES-STM-2025-d2f2d7	\N	ADMIN-PROD-2025-1c041d	\N	1	4745.52	4745.52	0.00	0	\N	\N	2025-03-30 06:17:26.333539	\N	\N
SALES-STI-2025-15c122	SALES-STM-2025-d2f2d7	\N	ADMIN-PROD-2025-c5c83a	\N	1	162319.25	162319.25	0.00	0	\N	\N	2025-03-30 06:17:26.333539	\N	\N
SALES-STI-2025-7b3370	SALES-STM-2025-d2f2d7	\N	ADMIN-PROD-2025-a17047	\N	1	299707.20	299707.20	0.00	0	\N	\N	2025-03-30 06:17:26.333539	\N	\N
SALES-STI-2025-788ef5	SALES-STM-2025-d2f2d7	\N	ADMIN-PROD-2025-115147	\N	1	154440.00	154440.00	0.00	0	\N	\N	2025-03-30 06:17:26.333539	\N	\N
SALES-STI-2025-2cee12	SALES-STM-2025-453f7f	\N	ADMIN-PROD-2025-5598cf	\N	1	13141.44	13141.44	0.00	0	\N	\N	2025-03-30 06:36:13.040246	\N	\N
SALES-STI-2025-b5e1e6	SALES-STM-2025-453f7f	\N	ADMIN-PROD-2025-467bbd	\N	1	12907.44	12907.44	0.00	0	\N	\N	2025-03-30 06:36:13.040246	\N	\N
SALES-STI-2025-2aa112	SALES-STM-2025-453f7f	\N	ADMIN-PROD-2025-1c041d	\N	1	4745.52	4745.52	0.00	0	\N	\N	2025-03-30 06:36:13.040246	\N	\N
SALES-STI-2025-e0f711	SALES-STM-2025-453f7f	\N	ADMIN-PROD-2025-a17047	\N	1	299707.20	299707.20	0.00	0	\N	\N	2025-03-30 06:36:13.040246	\N	\N
SALES-STI-2025-f8810e	SALES-STM-2025-453f7f	\N	ADMIN-PROD-2025-115147	\N	1	154440.00	154440.00	0.00	0	\N	\N	2025-03-30 06:36:13.040246	\N	\N
SALES-STI-2025-dbc86a	SALES-STM-2025-ad7bdb	\N	ADMIN-PROD-2025-5598cf	\N	1	13141.44	13141.44	0.00	0	\N	\N	2025-03-30 06:41:36.58817	\N	\N
SALES-STI-2025-80258b	SALES-STM-2025-ad7bdb	\N	ADMIN-PROD-2025-467bbd	\N	1	12907.44	12907.44	0.00	0	\N	\N	2025-03-30 06:41:36.58817	\N	\N
SALES-STI-2025-fe86dc	SALES-STM-2025-ad7bdb	\N	ADMIN-PROD-2025-1c041d	\N	1	4745.52	4745.52	0.00	0	\N	\N	2025-03-30 06:41:36.58817	\N	\N
SALES-STI-2025-1f9d2f	SALES-STM-2025-ad7bdb	\N	ADMIN-PROD-2025-a17047	\N	1	299707.20	299707.20	0.00	0	\N	\N	2025-03-30 06:41:36.58817	\N	\N
SALES-STI-2025-f6788c	SALES-STM-2025-22dcfc	\N	ADMIN-PROD-2025-8698b7	\N	1	1114666.00	1114666.00	0.00	0	\N	\N	2025-03-30 06:53:03.411777	\N	\N
SALES-STI-2025-33c4d0	SALES-STM-2025-177b2a	\N	ADMIN-PROD-2025-8698b7	\N	1	1114666.00	1114666.00	0.00	0	\N	\N	2025-03-30 07:02:07.828822	\N	\N
SALES-STI-2025-1edbe9	SALES-STM-2025-177b2a	\N	ADMIN-PROD-2025-941c5b	\N	1	262080.00	262080.00	0.00	0	\N	\N	2025-03-30 07:02:07.828822	\N	\N
SALES-STI-2025-8b517d	SALES-STM-2025-4aff81	\N	ADMIN-PROD-2025-8698b7	\N	1	1337599.20	1337599.20	0.00	0	\N	\N	2025-03-30 09:12:50.985127	\N	\N
SALES-STI-2025-a92b73	SALES-STM-2025-4aff81	\N	ADMIN-PROD-2025-b022f3	\N	1	262407.60	262407.60	0.00	0	\N	\N	2025-03-30 09:12:50.985127	\N	\N
SALES-STI-2025-f97ffd	SALES-STM-2025-4aff81	\N	ADMIN-PROD-2025-6db12d	\N	1	4745.52	4745.52	0.00	0	\N	\N	2025-03-30 09:12:50.985127	\N	\N
SALES-STI-2025-26dcdd	SALES-STM-2025-416e41	\N	ADMIN-PROD-2025-8698b7	\N	1	1337599.20	1337599.20	0.00	0	\N	\N	2025-03-30 09:12:50.985127	\N	\N
SALES-STI-2025-2392eb	SALES-STM-2025-416e41	\N	ADMIN-PROD-2025-b022f3	\N	1	262407.60	262407.60	0.00	0	\N	\N	2025-03-30 09:12:50.985127	\N	\N
SALES-STI-2025-162d69	SALES-STM-2025-416e41	\N	ADMIN-PROD-2025-6db12d	\N	1	4745.52	4745.52	0.00	0	\N	\N	2025-03-30 09:12:50.985127	\N	\N
SALES-STI-2025-c85039	SALES-STM-2025-08e3f7	\N	ADMIN-PROD-2025-115147	\N	1	154440.00	154440.00	0.00	18533	\N	\N	2025-03-30 09:12:50.985127	\N	\N
SALES-STI-2025-609a3e	SALES-STM-2025-08e3f7	\N	ADMIN-PROD-2025-c5c83a	\N	1	162319.25	162319.25	0.00	19478	\N	\N	2025-03-30 09:12:50.985127	\N	\N
SALES-STI-2025-06ca92	SALES-STM-2025-08e3f7	\N	ADMIN-PROD-2025-158fce	\N	1	4745.52	4745.52	0.00	569	\N	\N	2025-03-30 09:12:50.985127	\N	\N
SALES-STI-2025-ae3849	SALES-STM-2025-08e3f7	\N	ADMIN-PROD-2025-2e0ab6	\N	13	57271.97	744535.61	0.00	89344	\N	\N	2025-03-30 09:12:50.985127	\N	\N
SALES-STI-2025-930387	SALES-STM-2025-99cde0	\N	ADMIN-PROD-2025-115147	\N	1	154440.00	154440.00	0.00	18533	\N	\N	2025-03-30 09:12:50.985127	\N	\N
SALES-STI-2025-c273db	SALES-STM-2025-99cde0	\N	ADMIN-PROD-2025-c5c83a	\N	1	162319.25	162319.25	0.00	19478	\N	\N	2025-03-30 09:12:50.985127	\N	\N
SALES-STI-2025-af2aff	SALES-STM-2025-99cde0	\N	ADMIN-PROD-2025-158fce	\N	1	4745.52	4745.52	0.00	569	\N	\N	2025-03-30 09:12:50.985127	\N	\N
SALES-STI-2025-a37a08	SALES-STM-2025-99cde0	\N	ADMIN-PROD-2025-2e0ab6	\N	13	57271.97	744535.61	0.00	89344	\N	\N	2025-03-30 09:12:50.985127	\N	\N
SALES-STI-2025-9e46f9	SALES-STM-2025-0de2f8	\N	ADMIN-PROD-2025-8698b7	\N	1	1337599.20	1337599.20	0.00	0	\N	\N	2025-03-30 11:54:09.731525	\N	\N
SALES-STI-2025-99ebad	SALES-STM-2025-0de2f8	\N	ADMIN-PROD-2025-941c5b	\N	1	262080.00	262080.00	0.00	0	\N	\N	2025-03-30 11:54:09.731525	\N	\N
SALES-STI-2025-3baf66	SALES-STM-2025-0de2f8	\N	ADMIN-PROD-2025-83adb5	\N	1	154440.00	154440.00	0.00	0	\N	\N	2025-03-30 11:54:09.731525	\N	\N
SALES-STI-2025-19db95	SALES-STM-2025-e4c3a7	\N	ADMIN-PROD-2025-8698b7	\N	1	1337599.20	1337599.20	0.00	0	\N	\N	2025-03-30 11:54:09.731525	\N	\N
SALES-STI-2025-0f7dd7	SALES-STM-2025-e4c3a7	\N	ADMIN-PROD-2025-941c5b	\N	1	262080.00	262080.00	0.00	0	\N	\N	2025-03-30 11:54:09.731525	\N	\N
SALES-STI-2025-178591	SALES-STM-2025-e4c3a7	\N	ADMIN-PROD-2025-83adb5	\N	1	154440.00	154440.00	0.00	0	\N	\N	2025-03-30 11:54:09.731525	\N	\N
SALES-STI-2025-9f380b	SALES-STM-2025-e40c3c	\N	ADMIN-PROD-2025-744457	\N	1	262407.60	262407.60	0.00	31489	\N	\N	2025-03-30 13:28:41.521577	\N	\N
SALES-STI-2025-afee87	SALES-STM-2025-e40c3c	\N	ADMIN-PROD-2025-64c17b	\N	2	2246.40	4492.80	0.00	539	\N	\N	2025-03-30 13:28:41.521577	\N	\N
SALES-STI-2025-2163ba	SALES-STM-2025-e40c3c	\N	ADMIN-PROD-2025-2e0ab6	\N	4	57271.97	229087.88	0.00	27491	\N	\N	2025-03-30 13:28:41.521577	\N	\N
SALES-STI-2025-6ebbf5	SALES-STM-2025-e40c3c	\N	ADMIN-PROD-2025-51838d	\N	5	4680.00	23400.00	0.00	2808	\N	\N	2025-03-30 13:28:41.521577	\N	\N
SALES-STI-2025-749408	SALES-STM-2025-e40c3c	\N	ADMIN-PROD-2025-2a83ff	\N	1	1001.52	1001.52	0.00	120	\N	\N	2025-03-30 13:28:41.521577	\N	\N
SALES-STI-2025-808af5	SALES-STM-2025-e40c3c	\N	ADMIN-PROD-2025-941c5b	\N	1	262080.00	262080.00	0.00	31450	\N	\N	2025-03-30 13:28:41.521577	\N	\N
SALES-STI-2025-87107f	SALES-STM-2025-9913de	\N	ADMIN-PROD-2025-744457	\N	1	262407.60	262407.60	0.00	31489	\N	\N	2025-03-30 13:28:41.521577	\N	\N
SALES-STI-2025-4281cf	SALES-STM-2025-9913de	\N	ADMIN-PROD-2025-64c17b	\N	2	2246.40	4492.80	0.00	539	\N	\N	2025-03-30 13:28:41.521577	\N	\N
SALES-STI-2025-37a7b6	SALES-STM-2025-9913de	\N	ADMIN-PROD-2025-2e0ab6	\N	4	57271.97	229087.88	0.00	27491	\N	\N	2025-03-30 13:28:41.521577	\N	\N
SALES-STI-2025-ded86a	SALES-STM-2025-9913de	\N	ADMIN-PROD-2025-51838d	\N	5	4680.00	23400.00	0.00	2808	\N	\N	2025-03-30 13:28:41.521577	\N	\N
SALES-STI-2025-cd280b	SALES-STM-2025-9913de	\N	ADMIN-PROD-2025-2a83ff	\N	1	1001.52	1001.52	0.00	120	\N	\N	2025-03-30 13:28:41.521577	\N	\N
SALES-STI-2025-125f7d	SALES-STM-2025-9913de	\N	ADMIN-PROD-2025-941c5b	\N	1	262080.00	262080.00	0.00	31450	\N	\N	2025-03-30 13:28:41.521577	\N	\N
SALES-STI-2025-d51bcb	SALES-STM-2025-54405e	\N	ADMIN-PROD-2025-744457	\N	1	262407.60	262407.60	0.00	31489	\N	\N	2025-03-30 13:28:41.521577	\N	\N
SALES-STI-2025-2a5465	SALES-STM-2025-54405e	\N	ADMIN-PROD-2025-64c17b	\N	2	2246.40	4492.80	0.00	539	\N	\N	2025-03-30 13:28:41.521577	\N	\N
SALES-STI-2025-71d0d0	SALES-STM-2025-54405e	\N	ADMIN-PROD-2025-2e0ab6	\N	4	57271.97	229087.88	0.00	27491	\N	\N	2025-03-30 13:28:41.521577	\N	\N
SALES-STI-2025-f0afbc	SALES-STM-2025-54405e	\N	ADMIN-PROD-2025-51838d	\N	5	4680.00	23400.00	0.00	2808	\N	\N	2025-03-30 13:28:41.521577	\N	\N
SALES-STI-2025-8cef91	SALES-STM-2025-54405e	\N	ADMIN-PROD-2025-2a83ff	\N	1	1001.52	1001.52	0.00	120	\N	\N	2025-03-30 13:28:41.521577	\N	\N
SALES-STI-2025-ffe48d	SALES-STM-2025-54405e	\N	ADMIN-PROD-2025-941c5b	\N	1	262080.00	262080.00	0.00	31450	\N	\N	2025-03-30 13:28:41.521577	\N	\N
SALES-STI-2025-cc5026	SALES-STM-2025-9ced92	\N	ADMIN-PROD-2025-744457	\N	1	262407.60	262407.60	0.00	31489	\N	\N	2025-03-30 13:28:41.521577	\N	\N
SALES-STI-2025-e04d2b	SALES-STM-2025-9ced92	\N	ADMIN-PROD-2025-64c17b	\N	2	2246.40	4492.80	0.00	539	\N	\N	2025-03-30 13:28:41.521577	\N	\N
SALES-STI-2025-2af1ae	SALES-STM-2025-9ced92	\N	ADMIN-PROD-2025-2e0ab6	\N	4	57271.97	229087.88	0.00	27491	\N	\N	2025-03-30 13:28:41.521577	\N	\N
SALES-STI-2025-ceb40a	SALES-STM-2025-9ced92	\N	ADMIN-PROD-2025-51838d	\N	5	4680.00	23400.00	0.00	2808	\N	\N	2025-03-30 13:28:41.521577	\N	\N
SALES-STI-2025-aa25f5	SALES-STM-2025-9ced92	\N	ADMIN-PROD-2025-2a83ff	\N	1	1001.52	1001.52	0.00	120	\N	\N	2025-03-30 13:28:41.521577	\N	\N
SALES-STI-2025-a1ca0c	SALES-STM-2025-9ced92	\N	ADMIN-PROD-2025-941c5b	\N	1	262080.00	262080.00	0.00	31450	\N	\N	2025-03-30 13:28:41.521577	\N	\N
SALES-STI-2025-5140c3	SALES-STM-2025-7d1648	\N	ADMIN-PROD-2025-744457	\N	1	262407.60	262407.60	0.00	31489	\N	\N	2025-03-30 14:15:09.497299	\N	\N
SALES-STI-2025-e309e0	SALES-STM-2025-7d1648	\N	ADMIN-PROD-2025-64c17b	\N	2	2246.40	4492.80	0.00	539	\N	\N	2025-03-30 14:15:09.497299	\N	\N
SALES-STI-2025-742729	SALES-STM-2025-7d1648	\N	ADMIN-PROD-2025-2e0ab6	\N	4	57271.97	229087.88	0.00	27491	\N	\N	2025-03-30 14:15:09.497299	\N	\N
SALES-STI-2025-713ff1	SALES-STM-2025-7d1648	\N	ADMIN-PROD-2025-51838d	\N	5	4680.00	23400.00	0.00	2808	\N	\N	2025-03-30 14:15:09.497299	\N	\N
SALES-STI-2025-8fb984	SALES-STM-2025-7d1648	\N	ADMIN-PROD-2025-2a83ff	\N	1	1001.52	1001.52	0.00	120	\N	\N	2025-03-30 14:15:09.497299	\N	\N
SALES-STI-2025-67ec3b	SALES-STM-2025-7d1648	\N	ADMIN-PROD-2025-941c5b	\N	1	262080.00	262080.00	0.00	31450	\N	\N	2025-03-30 14:15:09.497299	\N	\N
SALES-STI-2025-3437a3	SALES-STM-2025-750b00	\N	ADMIN-PROD-2025-941c5b	\N	1	262080.00	262080.00	0.00	0	\N	\N	2025-03-30 14:19:27.023903	\N	\N
SALES-STI-2025-fed5b9	SALES-STM-2025-750b00	\N	ADMIN-PROD-2025-8698b7	\N	1	1337599.20	1337599.20	0.00	0	\N	\N	2025-03-30 14:19:27.023903	\N	\N
SALES-STI-2025-a82202	SALES-STM-2025-3112a4	\N	ADMIN-PROD-2025-290b77	\N	3	7291.44	21874.32	0.00	2625	\N	\N	2025-03-30 14:20:49.967551	\N	\N
SALES-STI-2025-458d0f	SALES-STM-2025-3112a4	\N	ADMIN-PROD-2025-467bbd	\N	15	12907.44	193611.60	0.00	23233	\N	\N	2025-03-30 14:20:49.967551	\N	\N
SALES-STI-2025-6f4e4d	SALES-STM-2025-8d6ddf	\N	ADMIN-PROD-2025-290b77	\N	3	7291.44	21874.32	0.00	2625	\N	\N	2025-03-30 14:20:49.967551	\N	\N
SALES-STI-2025-6f451c	SALES-STM-2025-8d6ddf	\N	ADMIN-PROD-2025-467bbd	\N	15	12907.44	193611.60	0.00	23233	\N	\N	2025-03-30 14:20:49.967551	\N	\N
SALES-STI-2025-ac54b5	SALES-STM-2025-b98977	\N	ADMIN-PROD-2025-290b77	\N	3	7291.44	21874.32	0.00	2625	\N	\N	2025-03-30 14:25:54.279228	\N	\N
SALES-STI-2025-5ef2e3	SALES-STM-2025-b98977	\N	ADMIN-PROD-2025-467bbd	\N	15	12907.44	193611.60	0.00	23233	\N	\N	2025-03-30 14:25:54.279228	\N	\N
SALES-STI-2025-284852	SALES-STM-2025-5e569c	\N	ADMIN-PROD-2025-2e0ab6	\N	1	57271.97	64144.61	0.00	6873		\N	2025-03-28 13:52:49	\N	\N
SALES-STI-2025-d75e18	SALES-STM-2025-3b4cb0	\N	ADMIN-PROD-2025-c5c83a	\N	3	162319.25	486957.75	0.00	58435	\N	\N	2025-03-31 09:29:10.609667	\N	\N
SALES-STI-2025-ce585c	SALES-STM-2025-3b4cb0	\N	ADMIN-PROD-2025-f3d852	\N	1	2246.40	2246.40	0.00	270	\N	\N	2025-03-31 09:29:10.609667	\N	\N
SALES-STI-2025-f13a93	SALES-STM-2025-3b4cb0	\N	ADMIN-PROD-2025-2e0ab6	\N	2	57271.97	114543.94	0.00	13745	\N	\N	2025-03-31 09:29:10.609667	\N	\N
SALES-STI-2025-24e940	SALES-STM-2025-3b4cb0	\N	ADMIN-PROD-2025-83adb5	\N	1	154440.00	154440.00	0.00	0	\N	\N	2025-03-31 09:29:10.609667	\N	\N
SALES-STI-2025-53b101	SALES-STM-2025-9a2b81	\N	ADMIN-PROD-2025-c5c83a	\N	3	162319.25	486957.75	11999.00	58435	\N	\N	2025-03-31 09:29:10.609667	\N	\N
SALES-STI-2025-fb9d33	SALES-STM-2025-9a2b81	\N	ADMIN-PROD-2025-f3d852	\N	1	2246.40	2246.40	0.00	270	\N	\N	2025-03-31 09:29:10.609667	\N	\N
SALES-STI-2025-8955c3	SALES-STM-2025-9a2b81	\N	ADMIN-PROD-2025-2e0ab6	\N	2	57271.97	114543.94	0.00	13745	\N	\N	2025-03-31 09:29:10.609667	\N	\N
SALES-STI-2025-55f9e5	SALES-STM-2025-9a2b81	\N	ADMIN-PROD-2025-83adb5	\N	1	154440.00	154440.00	20000.00	18533	\N	\N	2025-03-31 09:29:10.609667	\N	\N
SALES-STI-2025-342904	SALES-STM-2025-150ad6	\N	ADMIN-PROD-2025-c5c83a	\N	3	162319.25	486957.75	11999.00	58435	\N	\N	2025-03-31 09:29:10.609667	\N	\N
SALES-STI-2025-776eef	SALES-STM-2025-150ad6	\N	ADMIN-PROD-2025-f3d852	\N	1	2246.40	2246.40	0.00	270	\N	\N	2025-03-31 09:29:10.609667	\N	\N
SALES-STI-2025-55abe5	SALES-STM-2025-150ad6	\N	ADMIN-PROD-2025-2e0ab6	\N	2	57271.97	114543.94	0.00	13745	\N	\N	2025-03-31 09:29:10.609667	\N	\N
SALES-STI-2025-5b51ff	SALES-STM-2025-150ad6	\N	ADMIN-PROD-2025-83adb5	\N	1	154440.00	154440.00	20000.00	18533	\N	\N	2025-03-31 09:29:10.609667	\N	\N
SALES-STI-2025-0bb808	SALES-STM-2025-6e5388	\N	ADMIN-PROD-2025-8698b7	\N	1	1114666.00	1114666.00	0.00	0	\N	\N	2025-04-01 04:25:11.192344	\N	\N
SALES-STI-2025-55bbd4	SALES-STM-2025-0ada9a	\N	ADMIN-PROD-2025-8698b7	\N	1	1114666.00	1114666.00	0.00	0	\N	\N	2025-04-01 04:25:11.192344	\N	\N
SALES-STI-2025-821a97	SALES-STM-2025-07c8ee	\N	ADMIN-PROD-2025-5598cf	\N	1	10951.20	10951.20	0.00	0	\N	\N	2025-04-01 04:25:11.192344	\N	\N
SALES-STI-2025-e1fe80	SALES-STM-2025-4f9b8e	\N	ADMIN-PROD-2025-8698b7	\N	1	1114666.00	1114666.00	0.00	0	\N	\N	2025-04-01 04:32:26.123015	\N	\N
\.
...
SALES-TICKET-2025-b58bae	SALES-CUST-2025-dbfe2c	\N	asfd	afsd	Open	Low	2025-03-30 00:00:00
SALES-TICKET-2025-597bfa	SALES-CUST-2025-d105ee	HR-EMP-2025-fa5c60	sadf	dfsa	Open	Low	2025-03-30 00:00:00
SALES-TICKET-2025-7349ac	SALES-CUST-2025-d105ee	HR-EMP-2025-b15e2f	Equipment not turning on	Customer's equipment not turning on during testing	In Progress	High	2025-03-30 07:36:14.625
SALES-TICKET-2025-33343d	SALES-CUST-2025-b1576f	HR-EMP-2025-9e7313	Loose parts in equipment	customer received equipment in very bad condition. some parts were loose and came off	In Progress	High	2025-03-30 07:37:43.16
\.
...
SERVICES-ADDSER-2025-8d2aa5	100.00
SERVICES-ADDSER-2025-28ee61	250.00
SERVICES-ADDSER-2025-a0fbf0	75.50
SERVICES-ADDSER-2025-90721c	300.00
SERVICES-ADDSER-2025-4087df	150.75
SERVICES-ADDSER-2025-b3f227	200.00
SERVICES-ADDSER-2025-0085b0	500.00
SERVICES-ADDSER-2025-8dd47e	80.00
SERVICES-ADDSER-2025-8a6e57	600.00
SERVICES-ADDSER-2025-c49448	175.25
SERVICES-ADDSER-2025-2ffe65	120.00
SERVICES-ADDSER-2025-6529c4	90.50
SERVICES-ADDSER-2025-4453f5	110.00
SERVICES-ADDSER-2025-fa99cc	400.00
SERVICES-ADDSER-2025-49b0ce	60.00
SERVICES-ADDSER-2025-814d43	95.00
SERVICES-ADDSER-2025-c08f12	180.00
SERVICES-ADDSER-2025-c316c1	220.50
SERVICES-ADDSER-2025-deead7	275.00
SERVICES-ADDSER-2025-389905	140.00
\.
...
SERVICES-ADDSERTYPE-2025-d29958	\N	Maintenance	50.00	6	2024-01-01	Active	300.00
SERVICES-ADDSERTYPE-2025-1efd6f	\N	Extended Warranty	100.00	12	2023-07-01	Expired	1200.00
SERVICES-ADDSERTYPE-2025-03dd53	\N	Priority Service	30.00	3	2024-03-10	Active	90.00
SERVICES-ADDSERTYPE-2025-2575e7	\N	Maintenance	40.00	5	2023-08-15	Expired	200.00
SERVICES-ADDSERTYPE-2025-99ed70	\N	Extended Warranty	75.00	8	2024-02-20	Active	600.00
SERVICES-ADDSERTYPE-2025-b432db	\N	Priority Service	90.00	4	2023-06-01	Expired	360.00
SERVICES-ADDSERTYPE-2025-1f433d	\N	Maintenance	60.00	7	2024-04-05	Active	420.00
SERVICES-ADDSERTYPE-2025-2332ae	\N	Extended Warranty	125.00	10	2023-09-20	Expired	1250.00
SERVICES-ADDSERTYPE-2025-2d6da3	\N	Priority Service	45.00	6	2024-05-01	Active	270.00
SERVICES-ADDSERTYPE-2025-7a9c21	\N	Maintenance	70.00	5	2023-12-15	Expired	350.00
SERVICES-ADDSERTYPE-2025-ae2a24	\N	Extended Warranty	55.00	9	2024-06-10	Active	495.00
SERVICES-ADDSERTYPE-2025-a7520a	\N	Priority Service	35.00	2	2023-11-25	Expired	70.00
SERVICES-ADDSERTYPE-2025-b5e79e	\N	Maintenance	85.00	11	2024-07-01	Active	935.00
SERVICES-ADDSERTYPE-2025-d4f0fe	\N	Extended Warranty	95.00	6	2023-05-20	Expired	570.00
SERVICES-ADDSERTYPE-2025-9361fb	\N	Priority Service	120.00	4	2024-03-15	Active	480.00
SERVICES-ADDSERTYPE-2025-73f935	\N	Maintenance	25.00	3	2023-09-05	Expired	75.00
SERVICES-ADDSERTYPE-2025-8d1e46	\N	Extended Warranty	110.00	7	2024-02-10	Active	770.00
SERVICES-ADDSERTYPE-2025-bde3dd	\N	Priority Service	130.00	5	2023-08-01	Expired	650.00
SERVICES-ADDSERTYPE-2025-95a8ef	\N	Maintenance	95.00	8	2024-01-20	Active	760.00
SERVICES-ADDSERTYPE-2025-871a3f	\N	Extended Warranty	140.00	12	2023-04-15	Expired	1680.00
\.
...
SERVICES-SERCON-2025-94b908	\N	\N	\N	Annual software maintenance agreement	2024-01-10	2025-01-10	\N	Active	1	\N	\N	\N
SERVICES-SERCON-2025-c2eaea	\N	\N	\N	Monthly hardware servicing contract	2023-07-15	2024-07-15	\N	Expired	2	\N	\N	\N
SERVICES-SERCON-2025-99b8aa	\N	\N	\N	Extended warranty for premium users	2022-12-01	2023-12-01	\N	Terminated	1	\N	\N	\N
SERVICES-SERCON-2025-2554c6	\N	\N	\N	IT infrastructure support agreement	2024-02-20	2025-02-20	\N	Pending	3	\N	\N	\N
SERVICES-SERCON-2025-ab549e	\N	\N	\N	Managed services for cloud solutions	2024-03-05	2025-03-05	\N	Active	1	\N	\N	\N
SERVICES-SERCON-2025-0636fb	\N	\N	\N	One-time repair and maintenance contract	2023-09-10	2024-09-10	\N	Expired	1	\N	\N	\N
SERVICES-SERCON-2025-e6c019	\N	\N	\N	Annual cybersecurity support	2023-06-01	2024-06-01	\N	Terminated	2	\N	\N	\N
SERVICES-SERCON-2025-568c33	\N	\N	\N	Laptop leasing agreement	2024-04-01	2025-04-01	\N	Pending	5	\N	\N	\N
SERVICES-SERCON-2025-489096	\N	\N	\N	Software-as-a-service subscription	2023-11-20	2024-11-20	\N	Active	1	\N	\N	\N
SERVICES-SERCON-2025-09df2e	\N	\N	\N	Smart home system maintenance	2024-05-01	2025-05-01	\N	Pending	1	\N	\N	\N
SERVICES-SERCON-2025-88669c	\N	\N	\N	Printer repair service	2023-08-15	2024-08-15	\N	Expired	2	\N	\N	\N
SERVICES-SERCON-2025-ff7477	\N	\N	\N	Server management agreement	2024-06-10	2025-06-10	\N	Active	3	\N	\N	\N
SERVICES-SERCON-2025-35aebb	\N	\N	\N	Data recovery service package	2023-10-01	2024-10-01	\N	Terminated	1	\N	\N	\N
SERVICES-SERCON-2025-7e23ac	\N	\N	\N	Annual cloud storage contract	2024-01-01	2025-01-01	\N	Active	2	\N	\N	\N
SERVICES-SERCON-2025-aabaa9	\N	\N	\N	Enterprise IT support plan	2024-02-10	2025-02-10	\N	Pending	4	\N	\N	\N
SERVICES-SERCON-2025-7cd5fd	\N	\N	\N	Networking equipment lease	2023-05-20	2024-05-20	\N	Expired	1	\N	\N	\N
SERVICES-SERCON-2025-9495f5	\N	\N	\N	Subscription-based troubleshooting services	2024-03-15	2025-03-15	\N	Active	1	\N	\N	\N
SERVICES-SERCON-2025-22da36	\N	\N	\N	Enterprise database management	2024-07-01	2025-07-01	\N	Pending	2	\N	\N	\N
SERVICES-SERCON-2025-4b9cdd	\N	\N	\N	Custom software development contract	2023-09-05	2024-09-05	\N	Terminated	1	\N	\N	\N
SERVICES-SERCON-2025-6811f9	\N	\N	\N	Smart office automation service	2024-04-15	2025-04-15	\N	Active	1	\N	\N	\N
\.
...
COPY services.service_report (report_id, service_call_id, service_ticket_id, service_billing_id, technician_id, description, report_status, submission_date, renewal_id) FROM stdin;
SERVICES-REPORT-2025-43d259	\N	\N	\N	\N	Routine maintenance check completed	Submitted	2025-09-01	\N
SERVICES-REPORT-2025-70bf56	\N	\N	\N	\N	Replaced faulty power supply	Reviewed	2025-09-02	\N
SERVICES-REPORT-2025-5ec33a	\N	\N	\N	\N	Diagnosed network issue and provided solution	Draft	\N	\N
SERVICES-REPORT-2025-640d11	\N	\N	\N	\N	Resolved software compatibility issue	Submitted	2025-09-04	\N
SERVICES-REPORT-2025-426d39	\N	\N	\N	\N	Customer requested additional inspection	Reviewed	\N	\N
SERVICES-REPORT-2025-c544d4	\N	\N	\N	\N	Upgraded storage capacity on request	Draft	2025-09-06	\N
SERVICES-REPORT-2025-b10c7c	\N	\N	\N	\N	Fixed printer connectivity issue	Reviewed	2025-09-07	\N
SERVICES-REPORT-2025-3c32e5	\N	\N	\N	\N	Replaced defective laptop screen	Submitted	\N	\N
SERVICES-REPORT-2025-15cc46	\N	\N	\N	\N	Carried out a complete system diagnostics	Draft	2025-09-09	\N
SERVICES-REPORT-2025-579523	\N	\N	\N	\N	Provided training on security best practices	Submitted	2025-09-10	\N
SERVICES-REPORT-2025-a9e771	\N	\N	\N	\N	Installed new software update	Reviewed	2025-09-11	\N
SERVICES-REPORT-2025-10f8c6	\N	\N	\N	\N	Resolved customer complaint about slow system performance	Draft	\N	\N
SERVICES-REPORT-2025-81e0b8	\N	\N	\N	\N	Reconfigured wireless network	Submitted	2025-09-13	\N
SERVICES-REPORT-2025-9accd3	\N	\N	\N	\N	Completed installation of new security cameras	Reviewed	\N	\N
SERVICES-REPORT-2025-7c2312	\N	\N	\N	\N	Checked for overheating issue and applied fix	Draft	2025-09-15	\N
SERVICES-REPORT-2025-5c74be	\N	\N	\N	\N	Assisted with remote desktop configuration	Reviewed	2025-09-16	\N
SERVICES-REPORT-2025-c2bb10	\N	\N	\N	\N	Performed regular maintenance on enterprise server	Submitted	\N	\N
SERVICES-REPORT-2025-adfef6	\N	\N	\N	\N	Updated customer’s software licenses	Draft	2025-09-18	\N
SERVICES-REPORT-2025-2819e7	\N	\N	\N	\N	Checked and repaired external storage drive	Reviewed	2025-09-19	\N
SERVICES-REPORT-2025-cfca14	\N	\N	\N	\N	Advised customer on system upgrades	Submitted	\N	\N
SERVICES-REPORT-2025-b94009	\N	\N	\N	\N	Routine maintenance check completed	Submitted	2025-09-01	\N
SERVICES-REPORT-2025-fb87ff	\N	\N	\N	\N	Replaced faulty power supply	Reviewed	2025-09-02	\N
SERVICES-REPORT-2025-b66689	\N	\N	\N	\N	Diagnosed network issue and provided solution	Draft	\N	\N
SERVICES-REPORT-2025-a0a2af	\N	\N	\N	\N	Resolved software compatibility issue	Submitted	2025-09-04	\N
SERVICES-REPORT-2025-d9390e	\N	\N	\N	\N	Customer requested additional inspection	Reviewed	\N	\N
SERVICES-REPORT-2025-ec587b	\N	\N	\N	\N	Upgraded storage capacity on request	Draft	2025-09-06	\N
SERVICES-REPORT-2025-e79153	\N	\N	\N	\N	Fixed printer connectivity issue	Reviewed	2025-09-07	\N
SERVICES-REPORT-2025-ce34d1	\N	\N	\N	\N	Replaced defective laptop screen	Submitted	\N	\N
SERVICES-REPORT-2025-1162a9	\N	\N	\N	\N	Carried out a complete system diagnostics	Draft	2025-09-09	\N
SERVICES-REPORT-2025-a637d5	\N	\N	\N	\N	Provided training on security best practices	Submitted	2025-09-10	\N
SERVICES-REPORT-2025-157725	\N	\N	\N	\N	Installed new software update	Reviewed	2025-09-11	\N
SERVICES-REPORT-2025-43188f	\N	\N	\N	\N	Resolved customer complaint about slow system performance	Draft	\N	\N
SERVICES-REPORT-2025-0a4a53	\N	\N	\N	\N	Reconfigured wireless network	Submitted	2025-09-13	\N
SERVICES-REPORT-2025-37ee31	\N	\N	\N	\N	Completed installation of new security cameras	Reviewed	\N	\N
SERVICES-REPORT-2025-e1401b	\N	\N	\N	\N	Checked for overheating issue and applied fix	Draft	2025-09-15	\N
SERVICES-REPORT-2025-faa64d	\N	\N	\N	\N	Assisted with remote desktop configuration	Reviewed	2025-09-16	\N
SERVICES-REPORT-2025-2132d5	\N	\N	\N	\N	Performed regular maintenance on enterprise server	Submitted	\N	\N
SERVICES-REPORT-2025-9fcc31	\N	\N	\N	\N	Updated customer’s software licenses	Draft	2025-09-18	\N
SERVICES-REPORT-2025-1a2546	\N	\N	\N	\N	Checked and repaired external storage drive	Reviewed	2025-09-19	\N
SERVICES-REPORT-2025-29efd3	\N	\N	\N	\N	Advised customer on system upgrades	Submitted	\N	\N
SERVICES-REPORT-2025-455820	\N	\N	\N	\N	Initial diagnostic report for system error.	Draft	\N	\N
SERVICES-REPORT-2025-9aa3b7	\N	\N	\N	\N	Inspection completed, pending customer approval.	Submitted	2025-04-01	\N
SERVICES-REPORT-2025-ffe2f1	\N	\N	\N	\N	Finalized repair details and cost breakdown.	Reviewed	2025-04-01	\N
SERVICES-REPORT-2025-a05ade	\N	\N	\N	\N	Replacement of power adapter confirmed.	Draft	\N	\N
SERVICES-REPORT-2025-c40a25	\N	\N	\N	\N	Cooling system maintenance completed.	Submitted	2025-04-01	\N
SERVICES-REPORT-2025-6ddcfb	\N	\N	\N	\N	Customer requested additional software setup.	Reviewed	2025-04-01	\N
SERVICES-REPORT-2025-26ee71	\N	\N	\N	\N	Screen replacement performed successfully.	Draft	\N	\N
SERVICES-REPORT-2025-8c0d61	\N	\N	\N	\N	Network troubleshooting details documented.	Submitted	2025-04-01	\N
SERVICES-REPORT-2025-f63f91	\N	\N	\N	\N	Installation of security patches verified.	Reviewed	2025-04-01	\N
SERVICES-REPORT-2025-3a9e9d	\N	\N	\N	\N	Battery replacement completed, awaiting confirmation.	Draft	\N	\N
SERVICES-REPORT-2025-5100b9	\N	\N	\N	\N	Hardware diagnostics performed, no issues found.	Submitted	2025-04-01	\N
SERVICES-REPORT-2025-b20fae	\N	\N	\N	\N	Software upgrade successfully implemented.	Reviewed	2025-04-01	\N
SERVICES-REPORT-2025-2eee23	\N	\N	\N	\N	Customer reported intermittent connectivity issues.	Draft	\N	\N
SERVICES-REPORT-2025-4c14ac	\N	\N	\N	\N	Final assessment of motherboard repair done.	Submitted	2025-04-01	\N
SERVICES-REPORT-2025-4ea9db	\N	\N	\N	\N	System optimization report reviewed.	Reviewed	2025-04-01	\N
SERVICES-REPORT-2025-636808	\N	\N	\N	\N	USB hub installation report drafted.	Draft	\N	\N
SERVICES-REPORT-2025-ef7eea	\N	\N	\N	\N	Laptop overheating issue resolved.	Submitted	2025-04-01	\N
SERVICES-REPORT-2025-f28e17	\N	\N	\N	\N	External hard drive failure diagnosed.	Reviewed	2025-04-01	\N
SERVICES-REPORT-2025-d61a99	\N	\N	\N	\N	Customer requested additional warranty coverage.	Draft	\N	\N
SERVICES-REPORT-2025-2899e6	\N	\N	\N	\N	Customer feedback on service collected and reviewed.	Reviewed	2025-04-01	\N
\.
...
SELECT pg_catalog.setval('public.django_admin_log_id_seq', 339, true);
...
--
-- Name: orders trg_generate_sales_invoice; Type: TRIGGER; Schema: sales; Owner: postgres
--

CREATE TRIGGER trg_generate_sales_invoice AFTER INSERT ON sales.orders FOR EACH ROW EXECUTE FUNCTION public.generate_sales_invoice();
...
--
-- Name: shipping_details trg_update_invoice_from_shipping_details; Type: TRIGGER; Schema: sales; Owner: postgres
--

CREATE TRIGGER trg_update_invoice_from_shipping_details AFTER UPDATE ON sales.shipping_details FOR EACH ROW EXECUTE FUNCTION public.update_invoice_from_shipping_details();
...
--
-- Name: statement fk_statement_ext_project_request; Type: FK CONSTRAINT; Schema: sales; Owner: postgres
--

ALTER TABLE ONLY sales.statement
    ADD CONSTRAINT fk_statement_ext_project_request FOREIGN KEY (ext_project_request_id) REFERENCES project_management.external_project_request(ext_project_request_id) ON DELETE SET NULL;


--
-- Name: additional_service_type additional_service_type_additional_service_id_fkey; Type: FK CONSTRAINT; Schema: services; Owner: postgres
--

ALTER TABLE ONLY services.additional_service_type
    ADD CONSTRAINT additional_service_type_additional_service_id_fkey FOREIGN KEY (additional_service_id) REFERENCES services.additional_service(additional_service_id);
...
--
-- Name: service_report fk_report_renewal_id; Type: FK CONSTRAINT; Schema: services; Owner: postgres
--

ALTER TABLE ONLY services.service_report
    ADD CONSTRAINT fk_report_renewal_id FOREIGN KEY (renewal_id) REFERENCES sales.renewal_warranty(renewal_id);
